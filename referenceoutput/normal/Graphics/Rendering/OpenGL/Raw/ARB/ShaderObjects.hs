...
module Graphics.Rendering.OpenGL.Raw.ARB.ShaderObjects
       (glValidateProgramARB, glUseProgramObjectARB,
        ...
        glUniformMatrix2fvARB, glUniform4ivARB, glUniform4iARB,
        glUniform4fvARB, glUniform4fARB, glUniform3ivARB, glUniform3iARB,
        glUniform3fvARB, glUniform3fARB, glUniform2ivARB, glUniform2iARB,
        glUniform2fvARB, glUniform2fARB, glUniform1ivARB, glUniform1iARB,
        glUniform1fvARB, glUniform1fARB, glShaderSourceARB,
        glLinkProgramARB, glGetUniformivARB, glGetUniformfvARB,
        glGetUniformLocationARB, glGetShaderSourceARB,
        glGetObjectParameterivARB, glGetObjectParameterfvARB,
        glGetInfoLogARB, glGetHandleARB, glGetAttachedObjectsARB,
        glGetActiveUniformARB, glDetachObjectARB, glDeleteObjectARB,
        glCreateShaderObjectARB, glCreateProgramObjectARB,
        glCompileShaderARB, glAttachObjectARB, gl_SHADER_OBJECT_ARB,
        gl_SAMPLER_CUBE_ARB, gl_SAMPLER_3D_ARB, gl_SAMPLER_2D_SHADOW_ARB,
        gl_SAMPLER_2D_RECT_SHADOW_ARB, gl_SAMPLER_2D_RECT_ARB,
        gl_SAMPLER_2D_ARB, gl_SAMPLER_1D_SHADOW_ARB, gl_SAMPLER_1D_ARB,
        gl_PROGRAM_OBJECT_ARB, gl_OBJECT_VALIDATE_STATUS_ARB,
        gl_OBJECT_TYPE_ARB, gl_OBJECT_SUBTYPE_ARB,
        gl_OBJECT_SHADER_SOURCE_LENGTH_ARB, gl_OBJECT_LINK_STATUS_ARB,
        gl_OBJECT_INFO_LOG_LENGTH_ARB, gl_OBJECT_DELETE_STATUS_ARB,
        gl_OBJECT_COMPILE_STATUS_ARB, gl_OBJECT_ATTACHED_OBJECTS_ARB,
        gl_OBJECT_ACTIVE_UNIFORM_MAX_LENGTH_ARB,
        gl_OBJECT_ACTIVE_UNIFORMS_ARB, gl_INT_VEC4_ARB, gl_INT_VEC3_ARB,
        gl_INT_VEC2_ARB, gl_FLOAT_VEC4_ARB, gl_FLOAT_VEC3_ARB,
        gl_FLOAT_VEC2_ARB, gl_FLOAT_MAT4_ARB, gl_FLOAT_MAT3_ARB,
        gl_FLOAT_MAT2_ARB, gl_BOOL_VEC4_ARB, gl_BOOL_VEC3_ARB,
        gl_BOOL_VEC2_ARB, gl_BOOL_ARB)
       where
