...
module Graphics.Rendering.OpenGL.Raw.ARB.GeometryShader4
       (glProgramParameteriARB, glFramebufferTextureLayerARB,
        glFramebufferTextureFaceARB, glFramebufferTextureARB,
        gl_TRIANGLE_STRIP_ADJACENCY_ARB, gl_TRIANGLES_ADJACENCY_ARB,
        gl_PROGRAM_POINT_SIZE_ARB, gl_MAX_VERTEX_VARYING_COMPONENTS_ARB,
        gl_MAX_VARYING_COMPONENTS, gl_MAX_GEOMETRY_VARYING_COMPONENTS_ARB,
        gl_MAX_GEOMETRY_UNIFORM_COMPONENTS_ARB,
        gl_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS_ARB,
        gl_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS_ARB,
        gl_MAX_GEOMETRY_OUTPUT_VERTICES_ARB, gl_LINE_STRIP_ADJACENCY_ARB,
        gl_LINES_ADJACENCY_ARB, gl_GEOMETRY_VERTICES_OUT_ARB,
        gl_GEOMETRY_SHADER_ARB, gl_GEOMETRY_OUTPUT_TYPE_ARB,
