...
module Graphics.Rendering.OpenGL.Raw.ARB.OcclusionQuery
       (glIsQueryARB, glGetQueryivARB, glGetQueryObjectuivARB,
        glGetQueryObjectivARB, glGenQueriesARB, glEndQueryARB,
        glDeleteQueriesARB, glBeginQueryARB, gl_SAMPLES_PASSED_ARB,
