...
module Graphics.Rendering.OpenGL.Raw.EXT.DirectStateAccess
       (glUnmapNamedBufferEXT, glTextureSubImage3DEXT,
        glTextureSubImage2DEXT, glTextureSubImage1DEXT,
        glTextureRenderbufferEXT, glTextureParameterivEXT,
        glTextureParameteriEXT, glTextureParameterfvEXT,
        glTextureParameterfEXT, glTextureParameterIuivEXT,
        glTextureParameterIivEXT, glTextureImage3DEXT, glTextureImage2DEXT,
        glTextureImage1DEXT, glTextureBufferEXT,
        glPushClientAttribDefaultEXT, glProgramUniformMatrix4x3fvEXT,
        glProgramUniformMatrix4x3dvEXT, glProgramUniformMatrix4x2fvEXT,
        glProgramUniformMatrix4x2dvEXT, glProgramUniformMatrix4fvEXT,
        glProgramUniformMatrix4dvEXT, glProgramUniformMatrix3x4fvEXT,
        glProgramUniformMatrix3x4dvEXT, glProgramUniformMatrix3x2fvEXT,
        glProgramUniformMatrix3x2dvEXT, glProgramUniformMatrix3fvEXT,
        glProgramUniformMatrix3dvEXT, glProgramUniformMatrix2x4fvEXT,
        glProgramUniformMatrix2x4dvEXT, glProgramUniformMatrix2x3fvEXT,
        glProgramUniformMatrix2x3dvEXT, glProgramUniformMatrix2fvEXT,
        glProgramUniformMatrix2dvEXT, glProgramUniform4uivEXT,
        glProgramUniform4uiEXT, glProgramUniform4ivEXT,
        glProgramUniform4iEXT, glProgramUniform4fvEXT,
        glProgramUniform4fEXT, glProgramUniform4dvEXT,
        glProgramUniform4dEXT, glProgramUniform3uivEXT,
        glProgramUniform3uiEXT, glProgramUniform3ivEXT,
        glProgramUniform3iEXT, glProgramUniform3fvEXT,
        glProgramUniform3fEXT, glProgramUniform3dvEXT,
        glProgramUniform3dEXT, glProgramUniform2uivEXT,
        glProgramUniform2uiEXT, glProgramUniform2ivEXT,
        glProgramUniform2iEXT, glProgramUniform2fvEXT,
        glProgramUniform2fEXT, glProgramUniform2dvEXT,
        glProgramUniform2dEXT, glProgramUniform1uivEXT,
        glProgramUniform1uiEXT, glProgramUniform1ivEXT,
        glProgramUniform1iEXT, glProgramUniform1fvEXT,
        glProgramUniform1fEXT, glProgramUniform1dvEXT,
        glProgramUniform1dEXT, glNamedRenderbufferStorageMultisampleEXT,
        glNamedRenderbufferStorageMultisampleCoverageEXT,
        glNamedRenderbufferStorageEXT, glNamedProgramStringEXT,
        ...
        glNamedFramebufferTextureFaceEXT, glNamedFramebufferTextureEXT,
        glNamedFramebufferTexture3DEXT, glNamedFramebufferTexture2DEXT,
        glNamedFramebufferTexture1DEXT, glNamedFramebufferRenderbufferEXT,
        glNamedCopyBufferSubDataEXT, glNamedBufferSubDataEXT,
        glNamedBufferDataEXT, glMultiTexSubImage3DEXT,
        glMultiTexSubImage2DEXT, glMultiTexSubImage1DEXT,
        glMultiTexRenderbufferEXT, glMultiTexParameterivEXT,
        glMultiTexParameteriEXT, glMultiTexParameterfvEXT,
        glMultiTexParameterfEXT, glMultiTexParameterIuivEXT,
        glMultiTexParameterIivEXT, glMultiTexImage3DEXT,
        glMultiTexImage2DEXT, glMultiTexImage1DEXT, glMultiTexGenivEXT,
        glMultiTexGeniEXT, glMultiTexGenfvEXT, glMultiTexGenfEXT,
        glMultiTexGendvEXT, glMultiTexGendEXT, glMultiTexEnvivEXT,
        glMultiTexEnviEXT, glMultiTexEnvfvEXT, glMultiTexEnvfEXT,
        glMultiTexCoordPointerEXT, glMultiTexBufferEXT,
        glMatrixTranslatefEXT, glMatrixTranslatedEXT, glMatrixScalefEXT,
        glMatrixScaledEXT, glMatrixRotatefEXT, glMatrixRotatedEXT,
        glMatrixPushEXT, glMatrixPopEXT, glMatrixOrthoEXT,
        glMatrixMultfEXT, glMatrixMultdEXT, glMatrixMultTransposefEXT,
        glMatrixMultTransposedEXT, glMatrixLoadfEXT, glMatrixLoaddEXT,
        glMatrixLoadTransposefEXT, glMatrixLoadTransposedEXT,
        glMatrixLoadIdentityEXT, glMatrixFrustumEXT,
        glMapNamedBufferRangeEXT, glMapNamedBufferEXT,
        glGetTextureParameterivEXT, glGetTextureParameterfvEXT,
        glGetTextureParameterIuivEXT, glGetTextureParameterIivEXT,
        glGetTextureLevelParameterivEXT, glGetTextureLevelParameterfvEXT,
        glGetTextureImageEXT, glGetPointerIndexedvEXT,
        glGetNamedRenderbufferParameterivEXT, glGetNamedProgramivEXT,
        glGetNamedProgramStringEXT, glGetNamedProgramLocalParameterfvEXT,
        glGetNamedProgramLocalParameterdvEXT,
        glGetNamedProgramLocalParameterIuivEXT,
        glGetNamedProgramLocalParameterIivEXT,
        glGetNamedFramebufferAttachmentParameterivEXT,
        glGetNamedBufferSubDataEXT, glGetNamedBufferPointervEXT,
        glGetNamedBufferParameterivEXT, glGetMultiTexParameterivEXT,
        glGetMultiTexParameterfvEXT, glGetMultiTexParameterIuivEXT,
        glGetMultiTexParameterIivEXT, glGetMultiTexLevelParameterivEXT,
        glGetMultiTexLevelParameterfvEXT, glGetMultiTexImageEXT,
        glGetMultiTexGenivEXT, glGetMultiTexGenfvEXT,
        glGetMultiTexGendvEXT, glGetMultiTexEnvivEXT,
        glGetMultiTexEnvfvEXT, glGetFramebufferParameterivEXT,
        glGetFloatIndexedvEXT, glGetDoubleIndexedvEXT,
        glGetCompressedTextureImageEXT, glGetCompressedMultiTexImageEXT,
        glGenerateTextureMipmapEXT, glGenerateMultiTexMipmapEXT,
        glFramebufferReadBufferEXT, glFramebufferDrawBuffersEXT,
        glFramebufferDrawBufferEXT, glFlushMappedNamedBufferRangeEXT,
        glEnableClientStateIndexedEXT, glDisableClientStateIndexedEXT,
        glCopyTextureSubImage3DEXT, glCopyTextureSubImage2DEXT,
        glCopyTextureSubImage1DEXT, glCopyTextureImage2DEXT,
        glCopyTextureImage1DEXT, glCopyMultiTexSubImage3DEXT,
        glCopyMultiTexSubImage2DEXT, glCopyMultiTexSubImage1DEXT,
        glCopyMultiTexImage2DEXT, glCopyMultiTexImage1DEXT,
        glCompressedTextureSubImage3DEXT, glCompressedTextureSubImage2DEXT,
        glCompressedTextureSubImage1DEXT, glCompressedTextureImage3DEXT,
        glCompressedTextureImage2DEXT, glCompressedTextureImage1DEXT,
        glCompressedMultiTexSubImage3DEXT,
        glCompressedMultiTexSubImage2DEXT,
        glCompressedMultiTexSubImage1DEXT, glCompressedMultiTexImage3DEXT,
        glCompressedMultiTexImage2DEXT, glCompressedMultiTexImage1DEXT,
        glClientAttribDefaultEXT, glCheckNamedFramebufferStatusEXT,
        glBindMultiTextureEXT, gl_TRANSPOSE_PROGRAM_MATRIX_EXT,
        gl_PROGRAM_MATRIX_STACK_DEPTH_EXT, gl_PROGRAM_MATRIX_EXT)
       where
