...
module Graphics.Rendering.OpenGL.Raw.EXT.PalettedTexture
       (glGetColorTableParameterivEXT, glGetColorTableParameterfvEXT,
        glGetColorTableEXT, glColorTableEXT, gl_TEXTURE_INDEX_SIZE_EXT,
        gl_COLOR_INDEX8_EXT, gl_COLOR_INDEX4_EXT, gl_COLOR_INDEX2_EXT,
        gl_COLOR_INDEX1_EXT, gl_COLOR_INDEX16_EXT, gl_COLOR_INDEX12_EXT)
       where
