...
module Graphics.Rendering.OpenGL.Raw.NV.GpuProgram4
       (glProgramLocalParametersI4uivNV, glProgramLocalParametersI4ivNV,
        glProgramLocalParameterI4uivNV, glProgramLocalParameterI4uiNV,
        glProgramLocalParameterI4ivNV, glProgramLocalParameterI4iNV,
        glProgramEnvParametersI4uivNV, glProgramEnvParametersI4ivNV,
        glProgramEnvParameterI4uivNV, glProgramEnvParameterI4uiNV,
