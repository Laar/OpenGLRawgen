...
module Graphics.Rendering.OpenGL.Raw.NV.GeometryProgram4
       (glProgramVertexLimitNV, glFramebufferTextureLayerEXT,
        glFramebufferTextureFaceEXT, glFramebufferTextureEXT,
        ...
        gl_GEOMETRY_VERTICES_OUT_EXT, gl_GEOMETRY_PROGRAM_NV,
...
import Graphics.Rendering.OpenGL.Raw.EXT.GeometryShader4
       (gl_TRIANGLE_STRIP_ADJACENCY_EXT, gl_TRIANGLES_ADJACENCY_EXT,
        gl_PROGRAM_POINT_SIZE_EXT, gl_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS_EXT,
        gl_LINE_STRIP_ADJACENCY_EXT, gl_LINES_ADJACENCY_EXT,
        gl_GEOMETRY_VERTICES_OUT_EXT, gl_GEOMETRY_OUTPUT_TYPE_EXT,
