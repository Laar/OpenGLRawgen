...
module Graphics.Rendering.OpenGL.Raw.NV.FragmentProgram
       (glProgramNamedParameter4fvNV, glProgramNamedParameter4fNV,
        glProgramNamedParameter4dvNV, glProgramNamedParameter4dNV,
        glGetProgramNamedParameterfvNV, glGetProgramNamedParameterdvNV,
        gl_PROGRAM_ERROR_STRING_NV, gl_MAX_TEXTURE_IMAGE_UNITS_NV,
        gl_MAX_TEXTURE_COORDS_NV,
        gl_MAX_FRAGMENT_PROGRAM_LOCAL_PARAMETERS_NV,
        gl_FRAGMENT_PROGRAM_NV, gl_FRAGMENT_PROGRAM_BINDING_NV)
       where
