...
module Graphics.Rendering.OpenGL.Raw.NV.VertexBufferUnifiedMemory
       (glVertexFormatNV, glVertexAttribIFormatNV, glVertexAttribFormatNV,
        glTexCoordFormatNV, glSecondaryColorFormatNV, glNormalFormatNV,
        glIndexFormatNV, glGetIntegerui64i_vNV, glFogCoordFormatNV,
        glEdgeFlagFormatNV, glColorFormatNV, glBufferAddressRangeNV,
        gl_VERTEX_ATTRIB_ARRAY_UNIFIED_NV,
        gl_VERTEX_ATTRIB_ARRAY_LENGTH_NV,
        gl_VERTEX_ATTRIB_ARRAY_ADDRESS_NV, gl_VERTEX_ARRAY_LENGTH_NV,
        gl_VERTEX_ARRAY_ADDRESS_NV, gl_TEXTURE_COORD_ARRAY_LENGTH_NV,
        gl_TEXTURE_COORD_ARRAY_ADDRESS_NV,
        gl_SECONDARY_COLOR_ARRAY_LENGTH_NV,
        gl_SECONDARY_COLOR_ARRAY_ADDRESS_NV, gl_NORMAL_ARRAY_LENGTH_NV,
        gl_NORMAL_ARRAY_ADDRESS_NV, gl_INDEX_ARRAY_LENGTH_NV,
        gl_INDEX_ARRAY_ADDRESS_NV, gl_FOG_COORD_ARRAY_LENGTH_NV,
        gl_FOG_COORD_ARRAY_ADDRESS_NV, gl_ELEMENT_ARRAY_UNIFIED_NV,
        gl_ELEMENT_ARRAY_LENGTH_NV, gl_ELEMENT_ARRAY_ADDRESS_NV,
        gl_EDGE_FLAG_ARRAY_LENGTH_NV, gl_EDGE_FLAG_ARRAY_ADDRESS_NV,
        gl_DRAW_INDIRECT_UNIFIED_NV, gl_DRAW_INDIRECT_LENGTH_NV,
        gl_DRAW_INDIRECT_ADDRESS_NV, gl_COLOR_ARRAY_LENGTH_NV,
