...
module Graphics.Rendering.OpenGL.Raw.NV.VideoCapture
       (glVideoCaptureStreamParameterivNV,
        ...
        glVideoCaptureStreamParameterdvNV, glVideoCaptureNV,
        ...
        gl_Z4Y12Z4CB12Z4Y12Z4CR12_422_NV, gl_Z4Y12Z4CB12Z4CR12_444_NV,
        gl_Z4Y12Z4CB12Z4A12Z4Y12Z4CR12Z4A12_4224_NV, gl_YCBYCR8_422_NV,
        gl_YCBAYCR8A_4224_NV, gl_VIDEO_COLOR_CONVERSION_OFFSET_NV,
        ...
        gl_VIDEO_CAPTURE_FIELD_LOWER_HEIGHT_NV, gl_VIDEO_BUFFER_PITCH_NV,
        gl_VIDEO_BUFFER_NV, gl_VIDEO_BUFFER_INTERNAL_FORMAT_NV,
        gl_VIDEO_BUFFER_BINDING_NV, gl_SUCCESS_NV, gl_PARTIAL_SUCCESS_NV,
        gl_NUM_VIDEO_CAPTURE_STREAMS_NV,
        gl_NEXT_VIDEO_CAPTURE_BUFFER_STATUS_NV,
        gl_LAST_VIDEO_CAPTURE_STATUS_NV, gl_FIELD_UPPER_NV,
        gl_FIELD_LOWER_NV, gl_FAILURE_NV)
       where
