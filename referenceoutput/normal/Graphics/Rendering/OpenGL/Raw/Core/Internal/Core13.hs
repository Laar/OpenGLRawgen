...
module Graphics.Rendering.OpenGL.Raw.Core.Internal.Core13
       (glSampleCoverage, glGetCompressedTexImage,
        glCompressedTexSubImage3D, glCompressedTexSubImage2D,
        glCompressedTexSubImage1D, glCompressedTexImage3D,
        glCompressedTexImage2D, glCompressedTexImage1D, glActiveTexture,
        ...
        gl_TEXTURE_CUBE_MAP, gl_TEXTURE_COMPRESSION_HINT,
        gl_TEXTURE_COMPRESSED_IMAGE_SIZE, gl_TEXTURE_COMPRESSED,
        gl_TEXTURE_BINDING_CUBE_MAP, gl_TEXTURE9, gl_TEXTURE8, gl_TEXTURE7,
        gl_TEXTURE6, gl_TEXTURE5, gl_TEXTURE4, gl_TEXTURE31, gl_TEXTURE30,
        gl_TEXTURE3, gl_TEXTURE29, gl_TEXTURE28, gl_TEXTURE27,
        gl_TEXTURE26, gl_TEXTURE25, gl_TEXTURE24, gl_TEXTURE23,
        gl_TEXTURE22, gl_TEXTURE21, gl_TEXTURE20, gl_TEXTURE2,
        gl_TEXTURE19, gl_TEXTURE18, gl_TEXTURE17, gl_TEXTURE16,
        gl_TEXTURE15, gl_TEXTURE14, gl_TEXTURE13, gl_TEXTURE12,
        gl_TEXTURE11, gl_TEXTURE10, gl_TEXTURE1, gl_TEXTURE0,
        gl_SAMPLE_COVERAGE_VALUE, gl_SAMPLE_COVERAGE_INVERT,
        gl_SAMPLE_COVERAGE, gl_SAMPLE_BUFFERS, gl_SAMPLE_ALPHA_TO_ONE,
        gl_SAMPLE_ALPHA_TO_COVERAGE, gl_SAMPLES, gl_PROXY_TEXTURE_CUBE_MAP,
        gl_NUM_COMPRESSED_TEXTURE_FORMATS, gl_MULTISAMPLE,
        gl_MAX_CUBE_MAP_TEXTURE_SIZE, gl_COMPRESSED_TEXTURE_FORMATS,
        gl_COMPRESSED_RGBA, gl_COMPRESSED_RGB, gl_CLAMP_TO_BORDER,
        gl_ACTIVE_TEXTURE)
       where
