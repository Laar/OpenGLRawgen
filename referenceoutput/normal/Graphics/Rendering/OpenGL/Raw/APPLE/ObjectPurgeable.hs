...
module Graphics.Rendering.OpenGL.Raw.APPLE.ObjectPurgeable
       (glObjectUnpurgeableAPPLE, glObjectPurgeableAPPLE,
        glGetObjectParameterivAPPLE, gl_VOLATILE_APPLE, gl_UNDEFINED_APPLE,
        gl_RETAINED_APPLE, gl_RELEASED_APPLE, gl_PURGEABLE_APPLE,
