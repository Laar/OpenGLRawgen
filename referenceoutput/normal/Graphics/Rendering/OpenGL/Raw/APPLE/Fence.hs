...
module Graphics.Rendering.OpenGL.Raw.APPLE.Fence
       (glTestObjectAPPLE, glTestFenceAPPLE, glSetFenceAPPLE,
        glIsFenceAPPLE, glGenFencesAPPLE, glFinishObjectAPPLE,
        glFinishFenceAPPLE, glDeleteFencesAPPLE, gl_FENCE_APPLE,
