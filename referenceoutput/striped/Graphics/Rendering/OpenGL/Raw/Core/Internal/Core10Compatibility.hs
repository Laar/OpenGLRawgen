...
module Graphics.Rendering.OpenGL.Raw.Core.Internal.Core10Compatibility
       (glVertex4sv, glVertex4s, glVertex4iv, glVertex4i, glVertex4fv,
        glVertex4f, glVertex4dv, glVertex4d, glVertex3sv, glVertex3s,
        glVertex3iv, glVertex3i, glVertex3fv, glVertex3f, glVertex3dv,
        glVertex3d, glVertex2sv, glVertex2s, glVertex2iv, glVertex2i,
        glVertex2fv, glVertex2f, glVertex2dv, glVertex2d, glTranslatef,
        glTranslated, glTexGeniv, glTexGeni, glTexGenfv, glTexGenf,
        glTexGendv, glTexGend, glTexEnviv, glTexEnvi, glTexEnvfv,
        glTexEnvf, glTexCoord4sv, glTexCoord4s, glTexCoord4iv,
        glTexCoord4i, glTexCoord4fv, glTexCoord4f, glTexCoord4dv,
        glTexCoord4d, glTexCoord3sv, glTexCoord3s, glTexCoord3iv,
        glTexCoord3i, glTexCoord3fv, glTexCoord3f, glTexCoord3dv,
        glTexCoord3d, glTexCoord2sv, glTexCoord2s, glTexCoord2iv,
        glTexCoord2i, glTexCoord2fv, glTexCoord2f, glTexCoord2dv,
        glTexCoord2d, glTexCoord1sv, glTexCoord1s, glTexCoord1iv,
        glTexCoord1i, glTexCoord1fv, glTexCoord1f, glTexCoord1dv,
        glTexCoord1d, glShadeModel, glSelectBuffer, glScalef, glScaled,
        glRotatef, glRotated, glRenderMode, glRectsv, glRects, glRectiv,
        glRecti, glRectfv, glRectf, glRectdv, glRectd, glRasterPos4sv,
        ...
        glRasterPos2f, glRasterPos2dv, glRasterPos2d, glPushName,
        glPushMatrix, glPushAttrib, glPopName, glPopMatrix, glPopAttrib,
        glPolygonStipple, glPixelZoom, glPixelTransferi, glPixelTransferf,
        glPixelMapusv, glPixelMapuiv, glPixelMapfv, glPassThrough, glOrtho,
        glNormal3sv, glNormal3s, glNormal3iv, glNormal3i, glNormal3fv,
        glNormal3f, glNormal3dv, glNormal3d, glNormal3bv, glNormal3b,
        glNewList, glMultMatrixf, glMultMatrixd, glMatrixMode,
        glMaterialiv, glMateriali, glMaterialfv, glMaterialf, glMapGrid2f,
        glMapGrid2d, glMapGrid1f, glMapGrid1d, glMap2f, glMap2d, glMap1f,
        glMap1d, glLoadName, glLoadMatrixf, glLoadMatrixd, glLoadIdentity,
        glListBase, glLineStipple, glLightiv, glLighti, glLightfv,
        glLightf, glLightModeliv, glLightModeli, glLightModelfv,
        glLightModelf, glIsList, glInitNames, glIndexsv, glIndexs,
        glIndexiv, glIndexi, glIndexfv, glIndexf, glIndexdv, glIndexd,
        glIndexMask, glGetTexGeniv, glGetTexGenfv, glGetTexGendv,
        glGetTexEnviv, glGetTexEnvfv, glGetPolygonStipple,
        glGetPixelMapusv, glGetPixelMapuiv, glGetPixelMapfv,
        glGetMaterialiv, glGetMaterialfv, glGetMapiv, glGetMapfv,
        glGetMapdv, glGetLightiv, glGetLightfv, glGetClipPlane, glGenLists,
        glFrustum, glFogiv, glFogi, glFogfv, glFogf, glFeedbackBuffer,
        glEvalPoint2, glEvalPoint1, glEvalMesh2, glEvalMesh1,
        glEvalCoord2fv, glEvalCoord2f, glEvalCoord2dv, glEvalCoord2d,
        glEvalCoord1fv, glEvalCoord1f, glEvalCoord1dv, glEvalCoord1d,
        glEndList, glEnd, glEdgeFlagv, glEdgeFlag, glDrawPixels,
        glDeleteLists, glCopyPixels, glColorMaterial, glColor4usv,
        glColor4us, glColor4uiv, glColor4ui, glColor4ubv, glColor4ub,
        glColor4sv, glColor4s, glColor4iv, glColor4i, glColor4fv,
        glColor4f, glColor4dv, glColor4d, glColor4bv, glColor4b,
        glColor3usv, glColor3us, glColor3uiv, glColor3ui, glColor3ubv,
        glColor3ub, glColor3sv, glColor3s, glColor3iv, glColor3i,
        glColor3fv, glColor3f, glColor3dv, glColor3d, glColor3bv,
        glColor3b, glClipPlane, glClearIndex, glClearAccum, glCallLists,
        glCallList, glBitmap, glBegin, glAlphaFunc, glAccum)
       where
