...
module Graphics.Rendering.OpenGL.Raw.Core.Internal.Core33
       (glVertexP4uiv, glVertexP4ui, glVertexP3uiv, glVertexP3ui,
        ...
        glVertexAttribP1ui, glVertexAttribDivisor, glTexCoordP4uiv,
        glTexCoordP4ui, glTexCoordP3uiv, glTexCoordP3ui, glTexCoordP2uiv,
        glTexCoordP2ui, glTexCoordP1uiv, glTexCoordP1ui,
        glSecondaryColorP3uiv, glSecondaryColorP3ui, glSamplerParameteriv,
        glSamplerParameteri, glSamplerParameterfv, glSamplerParameterf,
        glSamplerParameterIuiv, glSamplerParameterIiv, glQueryCounter,
        glNormalP3uiv, glNormalP3ui, glMultiTexCoordP4uiv,
        glMultiTexCoordP4ui, glMultiTexCoordP3uiv, glMultiTexCoordP3ui,
        glMultiTexCoordP2uiv, glMultiTexCoordP2ui, glMultiTexCoordP1uiv,
        glMultiTexCoordP1ui, glIsSampler, glGetSamplerParameteriv,
        glGetSamplerParameterfv, glGetSamplerParameterIuiv,
        glGetSamplerParameterIiv, glGetQueryObjectui64v,
        glGetQueryObjecti64v, glGetFragDataIndex, glGenSamplers,
        glDeleteSamplers, glColorP4uiv, glColorP4ui, glColorP3uiv,
        glColorP3ui, glBindSampler, glBindFragDataLocationIndexed,
        gl_VERTEX_ATTRIB_ARRAY_DIVISOR, gl_TIME_ELAPSED, gl_TIMESTAMP,
        gl_TEXTURE_SWIZZLE_RGBA, gl_TEXTURE_SWIZZLE_R,
        gl_TEXTURE_SWIZZLE_G, gl_TEXTURE_SWIZZLE_B, gl_TEXTURE_SWIZZLE_A,
        gl_SRC1_COLOR, gl_SAMPLER_BINDING, gl_RGB10_A2UI,
