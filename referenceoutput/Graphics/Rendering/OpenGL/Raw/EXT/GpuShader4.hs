...
module Graphics.Rendering.OpenGL.Raw.EXT.GpuShader4
       (glUniform4uivEXT, glUniform3uivEXT, glUniform2uivEXT,
        glUniform1uivEXT, glUniform4uiEXT, glUniform3uiEXT,
        glUniform2uiEXT, glUniform1uiEXT, glGetFragDataLocationEXT,
        glBindFragDataLocationEXT, glGetUniformuivEXT,
        gl_UNSIGNED_INT_SAMPLER_BUFFER_EXT,
        gl_UNSIGNED_INT_SAMPLER_2D_ARRAY_EXT,
        gl_UNSIGNED_INT_SAMPLER_1D_ARRAY_EXT,
        gl_UNSIGNED_INT_SAMPLER_2D_RECT_EXT,
        gl_UNSIGNED_INT_SAMPLER_CUBE_EXT, gl_UNSIGNED_INT_SAMPLER_3D_EXT,
        gl_UNSIGNED_INT_SAMPLER_2D_EXT, gl_UNSIGNED_INT_SAMPLER_1D_EXT,
        gl_INT_SAMPLER_BUFFER_EXT, gl_INT_SAMPLER_2D_ARRAY_EXT,
        gl_INT_SAMPLER_1D_ARRAY_EXT, gl_INT_SAMPLER_2D_RECT_EXT,
        gl_INT_SAMPLER_CUBE_EXT, gl_INT_SAMPLER_3D_EXT,
        gl_INT_SAMPLER_2D_EXT, gl_INT_SAMPLER_1D_EXT,
        gl_UNSIGNED_INT_VEC4_EXT, gl_UNSIGNED_INT_VEC3_EXT,
        gl_UNSIGNED_INT_VEC2_EXT, gl_SAMPLER_CUBE_SHADOW_EXT,
        gl_SAMPLER_2D_ARRAY_SHADOW_EXT, gl_SAMPLER_1D_ARRAY_SHADOW_EXT,
        gl_SAMPLER_BUFFER_EXT, gl_SAMPLER_2D_ARRAY_EXT,
