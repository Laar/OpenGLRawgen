...
module Graphics.Rendering.OpenGL.Raw.EXT.Histogram
       (glResetMinmaxEXT, glResetHistogramEXT, glMinmaxEXT,
        ...
        glGetHistogramEXT, gl_TABLE_TOO_LARGE_EXT, gl_MINMAX_SINK_EXT,
        gl_MINMAX_FORMAT_EXT, gl_MINMAX_EXT, gl_HISTOGRAM_SINK_EXT,
        gl_HISTOGRAM_LUMINANCE_SIZE_EXT, gl_HISTOGRAM_ALPHA_SIZE_EXT,
        gl_HISTOGRAM_BLUE_SIZE_EXT, gl_HISTOGRAM_GREEN_SIZE_EXT,
        gl_HISTOGRAM_RED_SIZE_EXT, gl_HISTOGRAM_FORMAT_EXT,
        gl_HISTOGRAM_WIDTH_EXT, gl_PROXY_HISTOGRAM_EXT, gl_HISTOGRAM_EXT)
       where
