...
module Graphics.Rendering.OpenGL.Raw.EXT.LightTexture
       (glTextureMaterialEXT, glTextureLightEXT, glApplyTextureEXT,
        gl_FRAGMENT_DEPTH_EXT, gl_TEXTURE_MATERIAL_PARAMETER_EXT,
        gl_TEXTURE_MATERIAL_FACE_EXT, gl_TEXTURE_LIGHT_EXT,
        gl_TEXTURE_APPLICATION_MODE_EXT, gl_SHADOW_ATTENUATION_EXT,
        gl_ATTENUATION_EXT, gl_FRAGMENT_COLOR_EXT, gl_FRAGMENT_NORMAL_EXT,
