...
module Graphics.Rendering.OpenGL.Raw.EXT.FogCoord
       (glFogCoordfvEXT, glFogCoordfEXT, glFogCoorddvEXT, glFogCoorddEXT,
        glFogCoordPointerEXT, gl_FRAGMENT_DEPTH_EXT,
        gl_FOG_COORDINATE_SOURCE_EXT, gl_FOG_COORDINATE_EXT,
        gl_FOG_COORDINATE_ARRAY_TYPE_EXT,
        gl_FOG_COORDINATE_ARRAY_STRIDE_EXT,
        gl_FOG_COORDINATE_ARRAY_POINTER_EXT, gl_FOG_COORDINATE_ARRAY_EXT,
