...
module Graphics.Rendering.OpenGL.Raw.EXT.PixelTransform
       (glPixelTransformParameterfvEXT, glPixelTransformParameterivEXT,
        glPixelTransformParameterfEXT, glPixelTransformParameteriEXT,
        gl_PIXEL_TRANSFORM_2D_MATRIX_EXT,
        gl_MAX_PIXEL_TRANSFORM_2D_STACK_DEPTH_EXT,
        gl_PIXEL_TRANSFORM_2D_STACK_DEPTH_EXT, gl_AVERAGE_EXT,
        gl_CUBIC_EXT, gl_PIXEL_CUBIC_WEIGHT_EXT, gl_PIXEL_MIN_FILTER_EXT,
        gl_PIXEL_MAG_FILTER_EXT, gl_PIXEL_TRANSFORM_2D_EXT)
       where
