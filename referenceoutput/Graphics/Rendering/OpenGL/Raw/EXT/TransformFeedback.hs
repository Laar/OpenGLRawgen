...
module Graphics.Rendering.OpenGL.Raw.EXT.TransformFeedback
       (glGetTransformFeedbackVaryingEXT, glTransformFeedbackVaryingsEXT,
        glBindBufferBaseEXT, glBindBufferOffsetEXT, glBindBufferRangeEXT,
        glEndTransformFeedbackEXT, glBeginTransformFeedbackEXT,
        ...
        gl_PRIMITIVES_GENERATED_EXT, gl_SEPARATE_ATTRIBS_EXT,
