...
module Graphics.Rendering.OpenGL.Raw.EXT.VertexArray
       (glVertexPointerEXT, glTexCoordPointerEXT, glNormalPointerEXT,
        ...
        gl_EDGE_FLAG_ARRAY_POINTER_EXT, gl_TEXTURE_COORD_ARRAY_POINTER_EXT,
        gl_INDEX_ARRAY_POINTER_EXT, gl_COLOR_ARRAY_POINTER_EXT,
        gl_NORMAL_ARRAY_POINTER_EXT, gl_VERTEX_ARRAY_POINTER_EXT,
        gl_EDGE_FLAG_ARRAY_COUNT_EXT, gl_EDGE_FLAG_ARRAY_STRIDE_EXT,
        gl_TEXTURE_COORD_ARRAY_COUNT_EXT,
        gl_TEXTURE_COORD_ARRAY_STRIDE_EXT, gl_TEXTURE_COORD_ARRAY_TYPE_EXT,
        gl_TEXTURE_COORD_ARRAY_SIZE_EXT, gl_INDEX_ARRAY_COUNT_EXT,
        gl_INDEX_ARRAY_STRIDE_EXT, gl_INDEX_ARRAY_TYPE_EXT,
        gl_COLOR_ARRAY_COUNT_EXT, gl_COLOR_ARRAY_STRIDE_EXT,
        gl_COLOR_ARRAY_TYPE_EXT, gl_COLOR_ARRAY_SIZE_EXT,
        gl_NORMAL_ARRAY_COUNT_EXT, gl_NORMAL_ARRAY_STRIDE_EXT,
        gl_NORMAL_ARRAY_TYPE_EXT, gl_VERTEX_ARRAY_COUNT_EXT,
        gl_VERTEX_ARRAY_STRIDE_EXT, gl_VERTEX_ARRAY_TYPE_EXT,
        gl_VERTEX_ARRAY_SIZE_EXT, gl_EDGE_FLAG_ARRAY_EXT,
        gl_TEXTURE_COORD_ARRAY_EXT, gl_INDEX_ARRAY_EXT, gl_COLOR_ARRAY_EXT,
        gl_NORMAL_ARRAY_EXT, gl_VERTEX_ARRAY_EXT)
       where
