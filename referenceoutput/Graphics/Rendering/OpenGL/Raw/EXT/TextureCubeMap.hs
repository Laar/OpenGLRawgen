...
module Graphics.Rendering.OpenGL.Raw.EXT.TextureCubeMap
       (gl_TEXTURE_CUBE_MAP_POSITIVE_Z_EXT,
        ...
        gl_TEXTURE_CUBE_MAP_NEGATIVE_X_EXT, gl_TEXTURE_CUBE_MAP_EXT,
        gl_TEXTURE_BINDING_CUBE_MAP_EXT, gl_REFLECTION_MAP_EXT,
        gl_PROXY_TEXTURE_CUBE_MAP_EXT, gl_NORMAL_MAP_EXT,
