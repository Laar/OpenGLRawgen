...
module Graphics.Rendering.OpenGL.Raw.EXT.TextureSnorm
       (gl_SIGNED_NORMALIZED, gl_RGBA16_SNORM, gl_RGB16_SNORM,
        ...
        gl_RG_SNORM, gl_RED_SNORM, gl_INTENSITY16_SNORM,
        gl_LUMINANCE16_ALPHA16_SNORM, gl_LUMINANCE16_SNORM,
        gl_ALPHA16_SNORM, gl_INTENSITY8_SNORM, gl_LUMINANCE8_ALPHA8_SNORM,
        gl_LUMINANCE8_SNORM, gl_ALPHA8_SNORM, gl_INTENSITY_SNORM,
        gl_LUMINANCE_ALPHA_SNORM, gl_LUMINANCE_SNORM, gl_ALPHA_SNORM)
       where
import Graphics.Rendering.OpenGL.Raw.Core.Internal.Core31
       (gl_SIGNED_NORMALIZED, gl_RGBA16_SNORM, gl_RGB16_SNORM,
        gl_RG16_SNORM, gl_R16_SNORM, gl_RGBA8_SNORM, gl_RGB8_SNORM,
        gl_RG8_SNORM, gl_R8_SNORM, gl_RGBA_SNORM, gl_RGB_SNORM,
        gl_RG_SNORM, gl_RED_SNORM)
