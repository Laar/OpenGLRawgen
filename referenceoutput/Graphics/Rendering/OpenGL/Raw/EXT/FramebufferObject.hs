...
module Graphics.Rendering.OpenGL.Raw.EXT.FramebufferObject
       (glRenderbufferStorageEXT, glIsRenderbufferEXT, glIsFramebufferEXT,
        glGetRenderbufferParameterivEXT,
        glGetFramebufferAttachmentParameterivEXT, glGenerateMipmapEXT,
        glGenRenderbuffersEXT, glGenFramebuffersEXT,
        glFramebufferTexture3DEXT, glFramebufferTexture2DEXT,
        glFramebufferTexture1DEXT, glFramebufferRenderbufferEXT,
        glDeleteRenderbuffersEXT, glDeleteFramebuffersEXT,
        glCheckFramebufferStatusEXT, glBindRenderbufferEXT,
        glBindFramebufferEXT, gl_STENCIL_INDEX8_EXT, gl_STENCIL_INDEX4_EXT,
        gl_STENCIL_INDEX1_EXT, gl_STENCIL_INDEX16_EXT,
        gl_STENCIL_ATTACHMENT_EXT, gl_RENDERBUFFER_WIDTH_EXT,
        gl_RENDERBUFFER_STENCIL_SIZE_EXT, gl_RENDERBUFFER_RED_SIZE_EXT,
        gl_RENDERBUFFER_INTERNAL_FORMAT_EXT, gl_RENDERBUFFER_HEIGHT_EXT,
        gl_RENDERBUFFER_GREEN_SIZE_EXT, gl_RENDERBUFFER_EXT,
        gl_RENDERBUFFER_DEPTH_SIZE_EXT, gl_RENDERBUFFER_BLUE_SIZE_EXT,
        gl_RENDERBUFFER_BINDING_EXT, gl_RENDERBUFFER_ALPHA_SIZE_EXT,
        gl_MAX_RENDERBUFFER_SIZE_EXT, gl_MAX_COLOR_ATTACHMENTS_EXT,
        ...
        gl_FRAMEBUFFER_INCOMPLETE_ATTACHMENT_EXT, gl_FRAMEBUFFER_EXT,
        gl_FRAMEBUFFER_COMPLETE_EXT, gl_FRAMEBUFFER_BINDING_EXT,
        gl_FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL_EXT,
        gl_FRAMEBUFFER_ATTACHMENT_TEXTURE_CUBE_MAP_FACE_EXT,
        gl_FRAMEBUFFER_ATTACHMENT_TEXTURE_3D_ZOFFSET_EXT,
        gl_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE_EXT,
        gl_FRAMEBUFFER_ATTACHMENT_OBJECT_NAME_EXT, gl_DEPTH_ATTACHMENT_EXT,
        ...
        gl_COLOR_ATTACHMENT1_EXT, gl_COLOR_ATTACHMENT15_EXT,
        gl_COLOR_ATTACHMENT14_EXT, gl_COLOR_ATTACHMENT13_EXT,
        gl_COLOR_ATTACHMENT12_EXT, gl_COLOR_ATTACHMENT11_EXT,
        gl_COLOR_ATTACHMENT10_EXT, gl_COLOR_ATTACHMENT0_EXT)
       where
