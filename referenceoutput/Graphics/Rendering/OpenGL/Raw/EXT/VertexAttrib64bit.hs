...
module Graphics.Rendering.OpenGL.Raw.EXT.VertexAttrib64bit
       (glVertexAttribLPointerEXT, glVertexAttribL4dvEXT,
        glVertexAttribL4dEXT, glVertexAttribL3dvEXT, glVertexAttribL3dEXT,
        glVertexAttribL2dvEXT, glVertexAttribL2dEXT, glVertexAttribL1dvEXT,
        glVertexAttribL1dEXT, glVertexArrayVertexAttribLOffsetEXT,
        glGetVertexAttribLdvEXT, gl_DOUBLE_VEC4_EXT, gl_DOUBLE_VEC3_EXT,
        gl_DOUBLE_VEC2_EXT, gl_DOUBLE_MAT4x3_EXT, gl_DOUBLE_MAT4x2_EXT,
        gl_DOUBLE_MAT4_EXT, gl_DOUBLE_MAT3x4_EXT, gl_DOUBLE_MAT3x2_EXT,
        gl_DOUBLE_MAT3_EXT, gl_DOUBLE_MAT2x4_EXT, gl_DOUBLE_MAT2x3_EXT,
        gl_DOUBLE_MAT2_EXT, gl_DOUBLE)
       where
