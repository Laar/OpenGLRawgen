...
module Graphics.Rendering.OpenGL.Raw.EXT.VertexWeighting
       (glVertexWeightfvEXT, glVertexWeightfEXT, glVertexWeightPointerEXT,
        gl_VERTEX_WEIGHT_ARRAY_TYPE_EXT, gl_VERTEX_WEIGHT_ARRAY_STRIDE_EXT,
        gl_VERTEX_WEIGHT_ARRAY_SIZE_EXT,
        gl_VERTEX_WEIGHT_ARRAY_POINTER_EXT, gl_VERTEX_WEIGHT_ARRAY_EXT,
        gl_VERTEX_WEIGHTING_EXT, gl_MODELVIEW1_STACK_DEPTH_EXT,
        gl_MODELVIEW1_MATRIX_EXT, gl_MODELVIEW1_EXT,
        gl_MODELVIEW0_STACK_DEPTH_EXT, gl_MODELVIEW0_MATRIX_EXT,
        gl_MODELVIEW0_EXT, gl_CURRENT_VERTEX_WEIGHT_EXT)
       where
