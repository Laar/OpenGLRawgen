...
module Graphics.Rendering.OpenGL.Raw.EXT.Convolution
       (glSeparableFilter2DEXT, glGetSeparableFilterEXT,
        ...
        glConvolutionFilter1DEXT, gl_POST_CONVOLUTION_ALPHA_BIAS_EXT,
        ...
        gl_POST_CONVOLUTION_RED_SCALE_EXT, gl_MAX_CONVOLUTION_HEIGHT_EXT,
        gl_MAX_CONVOLUTION_WIDTH_EXT, gl_CONVOLUTION_HEIGHT_EXT,
        gl_CONVOLUTION_WIDTH_EXT, gl_CONVOLUTION_FORMAT_EXT, gl_REDUCE_EXT,
        gl_CONVOLUTION_FILTER_BIAS_EXT, gl_CONVOLUTION_FILTER_SCALE_EXT,
        gl_CONVOLUTION_BORDER_MODE_EXT, gl_SEPARABLE_2D_EXT,
        gl_CONVOLUTION_2D_EXT, gl_CONVOLUTION_1D_EXT)
       where
