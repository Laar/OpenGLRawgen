...
module Graphics.Rendering.OpenGL.Raw.ATI.VertexArrayObject
       (glGetVariantArrayObjectivATI, glGetVariantArrayObjectfvATI,
        glVariantArrayObjectATI, glGetArrayObjectivATI,
        glGetArrayObjectfvATI, glArrayObjectATI, glFreeObjectBufferATI,
        glGetObjectBufferivATI, glGetObjectBufferfvATI,
        glUpdateObjectBufferATI, glIsObjectBufferATI, glNewObjectBufferATI,
        gl_ARRAY_OBJECT_OFFSET_ATI, gl_ARRAY_OBJECT_BUFFER_ATI,
        gl_OBJECT_BUFFER_USAGE_ATI, gl_OBJECT_BUFFER_SIZE_ATI,
        gl_DISCARD_ATI, gl_PRESERVE_ATI, gl_DYNAMIC_ATI, gl_STATIC_ATI)
       where
