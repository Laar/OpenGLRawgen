...
module Graphics.Rendering.OpenGL.Raw.ATI.TextureFloat
       (gl_LUMINANCE_ALPHA_FLOAT16_ATI, gl_LUMINANCE_FLOAT16_ATI,
        gl_INTENSITY_FLOAT16_ATI, gl_ALPHA_FLOAT16_ATI, gl_RGB_FLOAT16_ATI,
        gl_RGBA_FLOAT16_ATI, gl_LUMINANCE_ALPHA_FLOAT32_ATI,
        gl_LUMINANCE_FLOAT32_ATI, gl_INTENSITY_FLOAT32_ATI,
        gl_ALPHA_FLOAT32_ATI, gl_RGB_FLOAT32_ATI, gl_RGBA_FLOAT32_ATI)
       where
