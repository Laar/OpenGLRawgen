...
module Graphics.Rendering.OpenGL.Raw.ATI.DrawBuffers
       (glDrawBuffersATI, gl_DRAW_BUFFER15_ATI, gl_DRAW_BUFFER14_ATI,
        gl_DRAW_BUFFER13_ATI, gl_DRAW_BUFFER12_ATI, gl_DRAW_BUFFER11_ATI,
        gl_DRAW_BUFFER10_ATI, gl_DRAW_BUFFER9_ATI, gl_DRAW_BUFFER8_ATI,
        gl_DRAW_BUFFER7_ATI, gl_DRAW_BUFFER6_ATI, gl_DRAW_BUFFER5_ATI,
        gl_DRAW_BUFFER4_ATI, gl_DRAW_BUFFER3_ATI, gl_DRAW_BUFFER2_ATI,
        gl_DRAW_BUFFER1_ATI, gl_DRAW_BUFFER0_ATI, gl_MAX_DRAW_BUFFERS_ATI)
       where
