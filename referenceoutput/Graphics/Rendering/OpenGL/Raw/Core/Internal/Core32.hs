...
module Graphics.Rendering.OpenGL.Raw.Core.Internal.Core32
       (glFramebufferTexture, glGetBufferParameteri64v, glGetInteger64i_v,
        ...
        glTexImage2DMultisample, glGetSynciv, glGetInteger64v, glWaitSync,
        glClientWaitSync, glDeleteSync, glIsSync, glFenceSync,
        glProvokingVertex, glMultiDrawElementsBaseVertex,
        glDrawElementsInstancedBaseVertex, glDrawRangeElementsBaseVertex,
        glDrawElementsBaseVertex, gl_MAX_INTEGER_SAMPLES,
        ...
        gl_SYNC_FLUSH_COMMANDS_BIT, gl_TIMEOUT_IGNORED, gl_WAIT_FAILED,
        gl_CONDITION_SATISFIED, gl_TIMEOUT_EXPIRED, gl_ALREADY_SIGNALED,
        gl_SIGNALED, gl_UNSIGNALED, gl_SYNC_GPU_COMMANDS_COMPLETE,
        gl_SYNC_FENCE, gl_SYNC_FLAGS, gl_SYNC_STATUS, gl_SYNC_CONDITION,
        gl_OBJECT_TYPE, gl_MAX_SERVER_WAIT_TIMEOUT,
        gl_TEXTURE_CUBE_MAP_SEAMLESS, gl_PROVOKING_VERTEX,
        gl_LAST_VERTEX_CONVENTION, gl_FIRST_VERTEX_CONVENTION,
        gl_QUADS_FOLLOW_PROVOKING_VERTEX_CONVENTION, gl_DEPTH_CLAMP,
        gl_FRAMEBUFFER_ATTACHMENT_TEXTURE_LAYER, gl_MAX_VARYING_COMPONENTS,
        gl_CONTEXT_PROFILE_MASK, gl_MAX_FRAGMENT_INPUT_COMPONENTS,
        gl_MAX_GEOMETRY_OUTPUT_COMPONENTS,
        gl_MAX_GEOMETRY_INPUT_COMPONENTS, gl_MAX_VERTEX_OUTPUT_COMPONENTS,
        gl_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS,
        gl_MAX_GEOMETRY_OUTPUT_VERTICES,
        gl_MAX_GEOMETRY_UNIFORM_COMPONENTS, gl_GEOMETRY_OUTPUT_TYPE,
        gl_GEOMETRY_INPUT_TYPE, gl_GEOMETRY_VERTICES_OUT,
        gl_GEOMETRY_SHADER, gl_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS,
        gl_FRAMEBUFFER_ATTACHMENT_LAYERED,
        gl_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS, gl_PROGRAM_POINT_SIZE,
