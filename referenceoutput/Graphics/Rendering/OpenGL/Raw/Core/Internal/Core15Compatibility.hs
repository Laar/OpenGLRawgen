...
module Graphics.Rendering.OpenGL.Raw.Core.Internal.Core15Compatibility
       (gl_SRC2_ALPHA, gl_SRC1_ALPHA, gl_SRC0_ALPHA, gl_SRC2_RGB,
        gl_SRC1_RGB, gl_SRC0_RGB, gl_FOG_COORD_ARRAY_BUFFER_BINDING,
        gl_FOG_COORD_ARRAY, gl_FOG_COORD_ARRAY_POINTER,
        gl_FOG_COORD_ARRAY_STRIDE, gl_FOG_COORD_ARRAY_TYPE,
        gl_CURRENT_FOG_COORD, gl_FOG_COORD, gl_FOG_COORD_SRC,
        gl_WEIGHT_ARRAY_BUFFER_BINDING,
        gl_FOG_COORDINATE_ARRAY_BUFFER_BINDING,
        gl_SECONDARY_COLOR_ARRAY_BUFFER_BINDING,
        gl_EDGE_FLAG_ARRAY_BUFFER_BINDING,
        gl_TEXTURE_COORD_ARRAY_BUFFER_BINDING,
        gl_INDEX_ARRAY_BUFFER_BINDING, gl_COLOR_ARRAY_BUFFER_BINDING,
        gl_NORMAL_ARRAY_BUFFER_BINDING, gl_VERTEX_ARRAY_BUFFER_BINDING)
       where
