...
module Graphics.Rendering.OpenGL.Raw.Core.Internal.Core31
       (glUniformBlockBinding, glTexBuffer, glPrimitiveRestartIndex,
        glGetUniformIndices, glGetUniformBlockIndex, glGetActiveUniformsiv,
        glGetActiveUniformName, glGetActiveUniformBlockiv,
        glGetActiveUniformBlockName, glDrawElementsInstanced,
        glDrawArraysInstanced, glCopyBufferSubData,
        ...
        gl_TEXTURE_RECTANGLE, gl_TEXTURE_BUFFER_DATA_STORE_BINDING,
        gl_TEXTURE_BUFFER, gl_TEXTURE_BINDING_RECTANGLE,
        gl_TEXTURE_BINDING_BUFFER, gl_SIGNED_NORMALIZED, gl_SAMPLER_BUFFER,
        gl_SAMPLER_2D_RECT_SHADOW, gl_SAMPLER_2D_RECT, gl_RG_SNORM,
        gl_RGB_SNORM, gl_RGBA_SNORM, gl_RGBA8_SNORM, gl_RGBA16_SNORM,
        gl_RGB8_SNORM, gl_RGB16_SNORM, gl_RG8_SNORM, gl_RG16_SNORM,
        gl_RED_SNORM, gl_R8_SNORM, gl_R16_SNORM,
        gl_PROXY_TEXTURE_RECTANGLE, gl_PRIMITIVE_RESTART_INDEX,
        gl_PRIMITIVE_RESTART, gl_MAX_VERTEX_UNIFORM_BLOCKS,
...
glGetUniformIndices ::
                    GLuint -> GLsizei -> Ptr GLchar -> Ptr GLuint -> IO ()
glGetUniformIndices
