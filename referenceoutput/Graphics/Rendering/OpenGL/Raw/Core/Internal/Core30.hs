...
module Graphics.Rendering.OpenGL.Raw.Core.Internal.Core30
       (glVertexAttribIPointer, glVertexAttribI4usv, glVertexAttribI4uiv,
        ...
        glTransformFeedbackVaryings, glTexParameterIuiv, glTexParameterIiv,
        glRenderbufferStorageMultisample, glRenderbufferStorage,
        glMapBufferRange, glIsVertexArray, glIsRenderbuffer,
        glIsFramebuffer, glIsEnabledi, glGetVertexAttribIuiv,
        glGetVertexAttribIiv, glGetUniformuiv,
        glGetTransformFeedbackVarying, glGetTexParameterIuiv,
        glGetTexParameterIiv, glGetStringi, glGetRenderbufferParameteriv,
        glGetIntegeri_v, glGetFramebufferAttachmentParameteriv,
        glGetFragDataLocation, glGetBooleani_v, glGenerateMipmap,
        glGenVertexArrays, glGenRenderbuffers, glGenFramebuffers,
        glFramebufferTextureLayer, glFramebufferTexture3D,
        glFramebufferTexture2D, glFramebufferTexture1D,
        glFramebufferRenderbuffer, glFlushMappedBufferRange,
        glEndTransformFeedback, glEndConditionalRender, glEnablei,
        glDisablei, glDeleteVertexArrays, glDeleteRenderbuffers,
        glDeleteFramebuffers, glColorMaski, glClearBufferuiv,
        glClearBufferiv, glClearBufferfv, glClearBufferfi, glClampColor,
        glCheckFramebufferStatus, glBlitFramebuffer, glBindVertexArray,
        glBindRenderbuffer, glBindFramebuffer, glBindFragDataLocation,
        glBindBufferRange, glBindBufferBase, glBeginTransformFeedback,
        glBeginConditionalRender, gl_VERTEX_ATTRIB_ARRAY_INTEGER,
        gl_VERTEX_ARRAY_BINDING, gl_UNSIGNED_NORMALIZED,
        gl_UNSIGNED_INT_VEC4, gl_UNSIGNED_INT_VEC3, gl_UNSIGNED_INT_VEC2,
        gl_UNSIGNED_INT_SAMPLER_CUBE, gl_UNSIGNED_INT_SAMPLER_3D,
        gl_UNSIGNED_INT_SAMPLER_2D_ARRAY, gl_UNSIGNED_INT_SAMPLER_2D,
        gl_UNSIGNED_INT_SAMPLER_1D_ARRAY, gl_UNSIGNED_INT_SAMPLER_1D,
        gl_UNSIGNED_INT_5_9_9_9_REV, gl_UNSIGNED_INT_24_8,
        ...
        gl_TEXTURE_RED_TYPE, gl_TEXTURE_GREEN_TYPE, gl_TEXTURE_DEPTH_TYPE,
        gl_TEXTURE_BLUE_TYPE, gl_TEXTURE_BINDING_2D_ARRAY,
        gl_TEXTURE_BINDING_1D_ARRAY, gl_TEXTURE_ALPHA_TYPE,
        gl_TEXTURE_2D_ARRAY, gl_TEXTURE_1D_ARRAY, gl_STENCIL_INDEX8,
        gl_STENCIL_INDEX4, gl_STENCIL_INDEX16, gl_STENCIL_INDEX1,
        gl_STENCIL_ATTACHMENT, gl_SEPARATE_ATTRIBS, gl_SAMPLER_CUBE_SHADOW,
        gl_SAMPLER_2D_ARRAY_SHADOW, gl_SAMPLER_2D_ARRAY,
        gl_SAMPLER_1D_ARRAY_SHADOW, gl_SAMPLER_1D_ARRAY, gl_RG_INTEGER,
        gl_RGB_INTEGER, gl_RGBA_INTEGER, gl_RGBA8UI, gl_RGBA8I,
        gl_RGBA32UI, gl_RGBA32I, gl_RGBA32F, gl_RGBA16UI, gl_RGBA16I,
        gl_RGBA16F, gl_RGB9_E5, gl_RGB8UI, gl_RGB8I, gl_RGB32UI, gl_RGB32I,
        gl_RGB32F, gl_RGB16UI, gl_RGB16I, gl_RGB16F, gl_RG8UI, gl_RG8I,
        gl_RG8, gl_RG32UI, gl_RG32I, gl_RG32F, gl_RG16UI, gl_RG16I,
        gl_RG16F, gl_RG16, gl_RG, gl_RENDERBUFFER_WIDTH,
        ...
        gl_RENDERBUFFER_DEPTH_SIZE, gl_RENDERBUFFER_BLUE_SIZE,
        gl_RENDERBUFFER_BINDING, gl_RENDERBUFFER_ALPHA_SIZE,
        gl_RENDERBUFFER, gl_RED_INTEGER, gl_READ_FRAMEBUFFER_BINDING,
        gl_READ_FRAMEBUFFER, gl_RASTERIZER_DISCARD, gl_R8UI, gl_R8I, gl_R8,
        gl_R32UI, gl_R32I, gl_R32F, gl_R16UI, gl_R16I, gl_R16F, gl_R16,
        gl_R11F_G11F_B10F, gl_QUERY_WAIT, gl_QUERY_NO_WAIT,
        gl_QUERY_BY_REGION_WAIT, gl_QUERY_BY_REGION_NO_WAIT,
        gl_PROXY_TEXTURE_2D_ARRAY, gl_PROXY_TEXTURE_1D_ARRAY,
        gl_PRIMITIVES_GENERATED, gl_NUM_EXTENSIONS,
        gl_MIN_PROGRAM_TEXEL_OFFSET, gl_MINOR_VERSION,
        gl_MAX_VARYING_COMPONENTS,
        gl_MAX_TRANSFORM_FEEDBACK_SEPARATE_COMPONENTS,
        gl_MAX_TRANSFORM_FEEDBACK_SEPARATE_ATTRIBS,
        gl_MAX_TRANSFORM_FEEDBACK_INTERLEAVED_COMPONENTS, gl_MAX_SAMPLES,
        gl_MAX_RENDERBUFFER_SIZE, gl_MAX_PROGRAM_TEXEL_OFFSET,
        gl_MAX_COLOR_ATTACHMENTS, gl_MAX_CLIP_DISTANCES,
        gl_MAX_ARRAY_TEXTURE_LAYERS, gl_MAP_WRITE_BIT,
        gl_MAP_UNSYNCHRONIZED_BIT, gl_MAP_READ_BIT,
        gl_MAP_INVALIDATE_RANGE_BIT, gl_MAP_INVALIDATE_BUFFER_BIT,
        gl_MAP_FLUSH_EXPLICIT_BIT, gl_MAJOR_VERSION,
        gl_INVALID_FRAMEBUFFER_OPERATION, gl_INT_SAMPLER_CUBE,
        gl_INT_SAMPLER_3D, gl_INT_SAMPLER_2D_ARRAY, gl_INT_SAMPLER_2D,
        gl_INT_SAMPLER_1D_ARRAY, gl_INT_SAMPLER_1D, gl_INTERLEAVED_ATTRIBS,
        gl_INDEX, gl_HALF_FLOAT, gl_GREEN_INTEGER,
        gl_FRAMEBUFFER_UNSUPPORTED, gl_FRAMEBUFFER_UNDEFINED,
        gl_FRAMEBUFFER_SRGB, gl_FRAMEBUFFER_INCOMPLETE_READ_BUFFER,
        ...
        gl_FLOAT_32_UNSIGNED_INT_24_8_REV, gl_FIXED_ONLY,
        gl_DRAW_FRAMEBUFFER_BINDING, gl_DRAW_FRAMEBUFFER,
        gl_DEPTH_STENCIL_ATTACHMENT, gl_DEPTH_STENCIL,
        gl_DEPTH_COMPONENT32F, gl_DEPTH_ATTACHMENT, gl_DEPTH32F_STENCIL8,
        gl_DEPTH24_STENCIL8, gl_CONTEXT_FLAG_FORWARD_COMPATIBLE_BIT,
        gl_CONTEXT_FLAGS, gl_COMPRESSED_SIGNED_RG_RGTC2,
        gl_COMPRESSED_SIGNED_RED_RGTC1, gl_COMPRESSED_RG_RGTC2,
        gl_COMPRESSED_RG, gl_COMPRESSED_RED_RGTC1, gl_COMPRESSED_RED,
        gl_COMPARE_REF_TO_TEXTURE, gl_COLOR_ATTACHMENT9,
        ...
        gl_COLOR_ATTACHMENT2, gl_COLOR_ATTACHMENT15, gl_COLOR_ATTACHMENT14,
        gl_COLOR_ATTACHMENT13, gl_COLOR_ATTACHMENT12,
        gl_COLOR_ATTACHMENT11, gl_COLOR_ATTACHMENT10, gl_COLOR_ATTACHMENT1,
        gl_COLOR_ATTACHMENT0, gl_CLIP_DISTANCE7, gl_CLIP_DISTANCE6,
        gl_CLIP_DISTANCE5, gl_CLIP_DISTANCE4, gl_CLIP_DISTANCE3,
        gl_CLIP_DISTANCE2, gl_CLIP_DISTANCE1, gl_CLIP_DISTANCE0,
        gl_CLAMP_READ_COLOR, gl_BUFFER_MAP_OFFSET, gl_BUFFER_MAP_LENGTH,
        gl_BUFFER_ACCESS_FLAGS, gl_BLUE_INTEGER, gl_BGR_INTEGER,
        gl_BGRA_INTEGER)
       where
...
glTransformFeedbackVaryings ::
                            GLuint -> GLsizei -> Ptr GLchar -> GLenum -> IO ()
glTransformFeedbackVaryings
