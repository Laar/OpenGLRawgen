...
module Graphics.Rendering.OpenGL.Raw.Core.Internal.Core41
       (glGetDoublei_v, glGetFloati_v, glDepthRangeIndexed,
        ...
        glViewportArrayv, glGetVertexAttribLdv, glVertexAttribLPointer,
        glVertexAttribL4dv, glVertexAttribL3dv, glVertexAttribL2dv,
        glVertexAttribL1dv, glVertexAttribL4d, glVertexAttribL3d,
        glVertexAttribL2d, glVertexAttribL1d, glGetProgramPipelineInfoLog,
        glValidateProgramPipeline, glProgramUniformMatrix4x3dv,
        glProgramUniformMatrix3x4dv, glProgramUniformMatrix4x2dv,
        glProgramUniformMatrix2x4dv, glProgramUniformMatrix3x2dv,
        glProgramUniformMatrix2x3dv, glProgramUniformMatrix4x3fv,
        glProgramUniformMatrix3x4fv, glProgramUniformMatrix4x2fv,
        glProgramUniformMatrix2x4fv, glProgramUniformMatrix3x2fv,
        glProgramUniformMatrix2x3fv, glProgramUniformMatrix4dv,
        glProgramUniformMatrix3dv, glProgramUniformMatrix2dv,
        glProgramUniformMatrix4fv, glProgramUniformMatrix3fv,
        glProgramUniformMatrix2fv, glProgramUniform4uiv,
        glProgramUniform4ui, glProgramUniform4dv, glProgramUniform4d,
        glProgramUniform4fv, glProgramUniform4f, glProgramUniform4iv,
        glProgramUniform4i, glProgramUniform3uiv, glProgramUniform3ui,
        glProgramUniform3dv, glProgramUniform3d, glProgramUniform3fv,
        glProgramUniform3f, glProgramUniform3iv, glProgramUniform3i,
        glProgramUniform2uiv, glProgramUniform2ui, glProgramUniform2dv,
        glProgramUniform2d, glProgramUniform2fv, glProgramUniform2f,
        glProgramUniform2iv, glProgramUniform2i, glProgramUniform1uiv,
        glProgramUniform1ui, glProgramUniform1dv, glProgramUniform1d,
        glProgramUniform1fv, glProgramUniform1f, glProgramUniform1iv,
        glProgramUniform1i, glGetProgramPipelineiv, glIsProgramPipeline,
        glGenProgramPipelines, glDeleteProgramPipelines,
        glBindProgramPipeline, glCreateShaderProgramv,
        glActiveShaderProgram, glUseProgramStages, glProgramParameteri,
        glProgramBinary, glGetProgramBinary, glClearDepthf, glDepthRangef,
        glGetShaderPrecisionFormat, glShaderBinary,
        glReleaseShaderCompiler, gl_UNDEFINED_VERTEX,
        gl_VIEWPORT_INDEX_PROVOKING_VERTEX, gl_LAYER_PROVOKING_VERTEX,
        gl_VIEWPORT_BOUNDS_RANGE, gl_VIEWPORT_SUBPIXEL_BITS,
        gl_MAX_VIEWPORTS, gl_PROGRAM_PIPELINE_BINDING, gl_ACTIVE_PROGRAM,
        ...
        gl_VERTEX_SHADER_BIT, gl_PROGRAM_BINARY_FORMATS,
        gl_NUM_PROGRAM_BINARY_FORMATS, gl_PROGRAM_BINARY_LENGTH,
        gl_PROGRAM_BINARY_RETRIEVABLE_HINT,
        gl_MAX_FRAGMENT_UNIFORM_VECTORS, gl_MAX_VARYING_VECTORS,
        gl_MAX_VERTEX_UNIFORM_VECTORS, gl_NUM_SHADER_BINARY_FORMATS,
        gl_SHADER_COMPILER, gl_HIGH_INT, gl_MEDIUM_INT, gl_LOW_INT,
        gl_HIGH_FLOAT, gl_MEDIUM_FLOAT, gl_LOW_FLOAT,
        gl_IMPLEMENTATION_COLOR_READ_FORMAT,
        gl_IMPLEMENTATION_COLOR_READ_TYPE, gl_FIXED)
       where
...
glDepthRangef :: GLclampf -> GLclampf -> IO ()
