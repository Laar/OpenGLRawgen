...
module Graphics.Rendering.OpenGL.Raw.Core.Internal.Core11
       (glIsTexture, glGenTextures, glDeleteTextures, glBindTexture,
        glTexSubImage2D, glTexSubImage1D, glCopyTexSubImage2D,
        glCopyTexSubImage1D, glCopyTexImage2D, glCopyTexImage1D,
        glPolygonOffset, glGetPointerv, glDrawElements, glDrawArrays,
        gl_RGBA16, gl_RGBA12, gl_RGB10_A2, gl_RGBA8, gl_RGB5_A1, gl_RGBA4,
        gl_RGBA2, gl_RGB16, gl_RGB12, gl_RGB10, gl_RGB8, gl_RGB5, gl_RGB4,
        gl_R3_G3_B2, gl_REPEAT, gl_PROXY_TEXTURE_2D, gl_PROXY_TEXTURE_1D,
        gl_TEXTURE_WRAP_T, gl_TEXTURE_WRAP_S, gl_TEXTURE_MIN_FILTER,
        gl_TEXTURE_MAG_FILTER, gl_LINEAR_MIPMAP_LINEAR,
        gl_NEAREST_MIPMAP_LINEAR, gl_LINEAR_MIPMAP_NEAREST,
        gl_NEAREST_MIPMAP_NEAREST, gl_LINEAR, gl_NEAREST, gl_EXTENSIONS,
        gl_VERSION, gl_RENDERER, gl_VENDOR, gl_DECR, gl_INCR, gl_REPLACE,
        gl_KEEP, gl_FILL, gl_LINE, gl_POINT, gl_RGBA, gl_RGB, gl_ALPHA,
        gl_BLUE, gl_GREEN, gl_RED, gl_DEPTH_COMPONENT, gl_STENCIL_INDEX,
        gl_STENCIL, gl_DEPTH, gl_COLOR, gl_TEXTURE, gl_SET, gl_NAND,
        gl_OR_INVERTED, gl_COPY_INVERTED, gl_OR_REVERSE, gl_INVERT,
        gl_EQUIV, gl_NOR, gl_OR, gl_XOR, gl_NOOP, gl_AND_INVERTED, gl_COPY,
        gl_AND_REVERSE, gl_AND, gl_CLEAR, gl_DOUBLE, gl_FLOAT,
        gl_UNSIGNED_INT, gl_INT, gl_UNSIGNED_SHORT, gl_SHORT,
        gl_UNSIGNED_BYTE, gl_BYTE, gl_NICEST, gl_FASTEST, gl_DONT_CARE,
        gl_TEXTURE_ALPHA_SIZE, gl_TEXTURE_BLUE_SIZE, gl_TEXTURE_GREEN_SIZE,
        gl_TEXTURE_RED_SIZE, gl_TEXTURE_BORDER_COLOR,
        gl_TEXTURE_INTERNAL_FORMAT, gl_TEXTURE_HEIGHT, gl_TEXTURE_WIDTH,
        gl_TEXTURE_BINDING_2D, gl_TEXTURE_BINDING_1D,
        gl_POLYGON_OFFSET_FACTOR, gl_POLYGON_OFFSET_FILL,
        gl_POLYGON_OFFSET_LINE, gl_POLYGON_OFFSET_POINT,
        gl_POLYGON_OFFSET_UNITS, gl_TEXTURE_2D, gl_TEXTURE_1D,
        gl_SUBPIXEL_BITS, gl_MAX_VIEWPORT_DIMS, gl_MAX_TEXTURE_SIZE,
        gl_PACK_ALIGNMENT, gl_PACK_SKIP_PIXELS, gl_PACK_SKIP_ROWS,
        gl_PACK_ROW_LENGTH, gl_PACK_LSB_FIRST, gl_PACK_SWAP_BYTES,
        gl_UNPACK_ALIGNMENT, gl_UNPACK_SKIP_PIXELS, gl_UNPACK_SKIP_ROWS,
        gl_UNPACK_ROW_LENGTH, gl_UNPACK_LSB_FIRST, gl_UNPACK_SWAP_BYTES,
        gl_POLYGON_SMOOTH_HINT, gl_LINE_SMOOTH_HINT, gl_STEREO,
        gl_DOUBLEBUFFER, gl_COLOR_WRITEMASK, gl_COLOR_CLEAR_VALUE,
        gl_SCISSOR_TEST, gl_SCISSOR_BOX, gl_READ_BUFFER, gl_DRAW_BUFFER,
        gl_COLOR_LOGIC_OP, gl_LOGIC_OP_MODE, gl_BLEND, gl_BLEND_SRC,
        gl_BLEND_DST, gl_DITHER, gl_VIEWPORT, gl_STENCIL_WRITEMASK,
        gl_STENCIL_REF, gl_STENCIL_PASS_DEPTH_PASS,
        gl_STENCIL_PASS_DEPTH_FAIL, gl_STENCIL_FAIL, gl_STENCIL_VALUE_MASK,
        gl_STENCIL_FUNC, gl_STENCIL_CLEAR_VALUE, gl_STENCIL_TEST,
        gl_DEPTH_FUNC, gl_DEPTH_CLEAR_VALUE, gl_DEPTH_WRITEMASK,
        gl_DEPTH_TEST, gl_DEPTH_RANGE, gl_FRONT_FACE, gl_CULL_FACE_MODE,
        gl_CULL_FACE, gl_POLYGON_SMOOTH, gl_LINE_WIDTH_GRANULARITY,
        gl_LINE_WIDTH_RANGE, gl_LINE_WIDTH, gl_LINE_SMOOTH,
        gl_POINT_SIZE_GRANULARITY, gl_POINT_SIZE_RANGE, gl_POINT_SIZE,
        gl_CCW, gl_CW, gl_OUT_OF_MEMORY, gl_INVALID_OPERATION,
        gl_INVALID_VALUE, gl_INVALID_ENUM, gl_NO_ERROR, gl_FRONT_AND_BACK,
        gl_RIGHT, gl_LEFT, gl_BACK, gl_FRONT, gl_BACK_RIGHT, gl_BACK_LEFT,
        gl_FRONT_RIGHT, gl_FRONT_LEFT, gl_NONE, gl_SRC_ALPHA_SATURATE,
        gl_ONE_MINUS_DST_COLOR, gl_DST_COLOR, gl_ONE_MINUS_DST_ALPHA,
        gl_DST_ALPHA, gl_ONE_MINUS_SRC_ALPHA, gl_SRC_ALPHA,
        gl_ONE_MINUS_SRC_COLOR, gl_SRC_COLOR, gl_ONE, gl_ZERO, gl_ALWAYS,
        gl_GEQUAL, gl_NOTEQUAL, gl_GREATER, gl_LEQUAL, gl_EQUAL, gl_LESS,
        gl_NEVER, gl_TRIANGLE_FAN, gl_TRIANGLE_STRIP, gl_TRIANGLES,
        gl_LINE_STRIP, gl_LINE_LOOP, gl_LINES, gl_POINTS, gl_TRUE,
        gl_FALSE, gl_COLOR_BUFFER_BIT, gl_STENCIL_BUFFER_BIT,
        gl_DEPTH_BUFFER_BIT)
       where
