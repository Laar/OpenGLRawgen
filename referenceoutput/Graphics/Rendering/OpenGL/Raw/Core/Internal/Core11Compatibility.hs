...
module Graphics.Rendering.OpenGL.Raw.Core.Internal.Core11Compatibility
       (glPushClientAttrib, glPopClientAttrib, glIndexubv, glIndexub,
        glPrioritizeTextures, glAreTexturesResident, glVertexPointer,
        glTexCoordPointer, glNormalPointer, glInterleavedArrays,
        glIndexPointer, glEnableClientState, glEdgeFlagPointer,
        glDisableClientState, glColorPointer, glArrayElement, gl_LIGHT7,
        gl_LIGHT6, gl_LIGHT5, gl_LIGHT4, gl_LIGHT3, gl_LIGHT2, gl_LIGHT1,
        gl_LIGHT0, gl_CLIP_PLANE5, gl_CLIP_PLANE4, gl_CLIP_PLANE3,
        gl_CLIP_PLANE2, gl_CLIP_PLANE1, gl_CLIP_PLANE0, gl_T4F_C4F_N3F_V4F,
        gl_T2F_C4F_N3F_V3F, gl_T2F_N3F_V3F, gl_T2F_C3F_V3F,
        gl_T2F_C4UB_V3F, gl_T4F_V4F, gl_T2F_V3F, gl_C4F_N3F_V3F,
        gl_N3F_V3F, gl_C3F_V3F, gl_C4UB_V3F, gl_C4UB_V2F, gl_V3F, gl_V2F,
        gl_INTENSITY16, gl_INTENSITY12, gl_INTENSITY8, gl_INTENSITY4,
        gl_INTENSITY, gl_LUMINANCE16_ALPHA16, gl_LUMINANCE12_ALPHA12,
        gl_LUMINANCE12_ALPHA4, gl_LUMINANCE8_ALPHA8, gl_LUMINANCE6_ALPHA2,
        gl_LUMINANCE4_ALPHA4, gl_LUMINANCE16, gl_LUMINANCE12,
        gl_LUMINANCE8, gl_LUMINANCE4, gl_ALPHA16, gl_ALPHA12, gl_ALPHA8,
        gl_ALPHA4, gl_CLAMP, gl_EYE_PLANE, gl_OBJECT_PLANE,
        gl_TEXTURE_GEN_MODE, gl_SPHERE_MAP, gl_OBJECT_LINEAR,
        gl_EYE_LINEAR, gl_TEXTURE_ENV, gl_TEXTURE_ENV_COLOR,
        gl_TEXTURE_ENV_MODE, gl_DECAL, gl_MODULATE, gl_Q, gl_R, gl_T, gl_S,
        gl_SMOOTH, gl_FLAT, gl_SELECT, gl_FEEDBACK, gl_RENDER, gl_BITMAP,
        gl_LUMINANCE_ALPHA, gl_LUMINANCE, gl_COLOR_INDEX, gl_PROJECTION,
        gl_MODELVIEW, gl_COLOR_INDEXES, gl_AMBIENT_AND_DIFFUSE,
        gl_SHININESS, gl_EMISSION, gl_4_BYTES, gl_3_BYTES, gl_2_BYTES,
        gl_COMPILE_AND_EXECUTE, gl_COMPILE, gl_QUADRATIC_ATTENUATION,
        gl_LINEAR_ATTENUATION, gl_CONSTANT_ATTENUATION, gl_SPOT_CUTOFF,
        gl_SPOT_EXPONENT, gl_SPOT_DIRECTION, gl_POSITION, gl_SPECULAR,
        gl_DIFFUSE, gl_AMBIENT, gl_TEXTURE_RESIDENT, gl_TEXTURE_PRIORITY,
        gl_TEXTURE_INTENSITY_SIZE, gl_TEXTURE_LUMINANCE_SIZE,
        gl_TEXTURE_BORDER, gl_TEXTURE_COMPONENTS,
        gl_EDGE_FLAG_ARRAY_STRIDE, gl_TEXTURE_COORD_ARRAY_STRIDE,
        gl_TEXTURE_COORD_ARRAY_TYPE, gl_TEXTURE_COORD_ARRAY_SIZE,
        gl_INDEX_ARRAY_STRIDE, gl_INDEX_ARRAY_TYPE, gl_COLOR_ARRAY_STRIDE,
        gl_COLOR_ARRAY_TYPE, gl_COLOR_ARRAY_SIZE, gl_NORMAL_ARRAY_STRIDE,
        gl_NORMAL_ARRAY_TYPE, gl_VERTEX_ARRAY_STRIDE, gl_VERTEX_ARRAY_TYPE,
        gl_VERTEX_ARRAY_SIZE, gl_EDGE_FLAG_ARRAY, gl_TEXTURE_COORD_ARRAY,
        gl_INDEX_ARRAY, gl_COLOR_ARRAY, gl_NORMAL_ARRAY, gl_VERTEX_ARRAY,
        gl_SELECTION_BUFFER_SIZE, gl_FEEDBACK_BUFFER_TYPE,
        gl_FEEDBACK_BUFFER_SIZE, gl_MAP2_GRID_SEGMENTS,
        gl_MAP2_GRID_DOMAIN, gl_MAP1_GRID_SEGMENTS, gl_MAP1_GRID_DOMAIN,
        gl_MAP2_VERTEX_4, gl_MAP2_VERTEX_3, gl_MAP2_TEXTURE_COORD_4,
        gl_MAP2_TEXTURE_COORD_3, gl_MAP2_TEXTURE_COORD_2,
        gl_MAP2_TEXTURE_COORD_1, gl_MAP2_NORMAL, gl_MAP2_INDEX,
        ...
        gl_MAP1_INDEX, gl_MAP1_COLOR_4, gl_AUTO_NORMAL,
        gl_NAME_STACK_DEPTH, gl_ACCUM_ALPHA_BITS, gl_ACCUM_BLUE_BITS,
        gl_ACCUM_GREEN_BITS, gl_ACCUM_RED_BITS, gl_STENCIL_BITS,
        gl_DEPTH_BITS, gl_ALPHA_BITS, gl_BLUE_BITS, gl_GREEN_BITS,
        gl_RED_BITS, gl_INDEX_BITS, gl_MAX_CLIENT_ATTRIB_STACK_DEPTH,
        gl_MAX_TEXTURE_STACK_DEPTH, gl_MAX_PROJECTION_STACK_DEPTH,
        gl_MAX_NAME_STACK_DEPTH, gl_MAX_MODELVIEW_STACK_DEPTH,
        gl_MAX_ATTRIB_STACK_DEPTH, gl_MAX_PIXEL_MAP_TABLE,
        gl_MAX_CLIP_PLANES, gl_MAX_LIGHTS, gl_MAX_EVAL_ORDER,
        gl_DEPTH_BIAS, gl_DEPTH_SCALE, gl_ALPHA_BIAS, gl_ALPHA_SCALE,
        gl_BLUE_BIAS, gl_BLUE_SCALE, gl_GREEN_BIAS, gl_GREEN_SCALE,
        gl_ZOOM_Y, gl_ZOOM_X, gl_RED_BIAS, gl_RED_SCALE, gl_INDEX_OFFSET,
        gl_INDEX_SHIFT, gl_MAP_STENCIL, gl_MAP_COLOR,
        gl_PIXEL_MAP_A_TO_A_SIZE, gl_PIXEL_MAP_B_TO_B_SIZE,
        gl_PIXEL_MAP_G_TO_G_SIZE, gl_PIXEL_MAP_R_TO_R_SIZE,
        gl_PIXEL_MAP_I_TO_A_SIZE, gl_PIXEL_MAP_I_TO_B_SIZE,
        gl_PIXEL_MAP_I_TO_G_SIZE, gl_PIXEL_MAP_I_TO_R_SIZE,
        gl_PIXEL_MAP_S_TO_S_SIZE, gl_PIXEL_MAP_I_TO_I_SIZE,
        gl_TEXTURE_GEN_Q, gl_TEXTURE_GEN_R, gl_TEXTURE_GEN_T,
        gl_TEXTURE_GEN_S, gl_FOG_HINT, gl_POINT_SMOOTH_HINT,
        gl_PERSPECTIVE_CORRECTION_HINT, gl_RENDER_MODE, gl_RGBA_MODE,
        gl_INDEX_MODE, gl_INDEX_WRITEMASK, gl_INDEX_CLEAR_VALUE,
        gl_AUX_BUFFERS, gl_LOGIC_OP, gl_INDEX_LOGIC_OP, gl_ALPHA_TEST_REF,
        gl_ALPHA_TEST_FUNC, gl_ALPHA_TEST, gl_CLIENT_ATTRIB_STACK_DEPTH,
        gl_ATTRIB_STACK_DEPTH, gl_TEXTURE_MATRIX, gl_PROJECTION_MATRIX,
        gl_MODELVIEW_MATRIX, gl_TEXTURE_STACK_DEPTH,
        gl_PROJECTION_STACK_DEPTH, gl_MODELVIEW_STACK_DEPTH, gl_NORMALIZE,
        gl_MATRIX_MODE, gl_ACCUM_CLEAR_VALUE, gl_FOG_COLOR, gl_FOG_MODE,
        gl_FOG_END, gl_FOG_START, gl_FOG_DENSITY, gl_FOG_INDEX, gl_FOG,
        gl_COLOR_MATERIAL, gl_COLOR_MATERIAL_PARAMETER,
        gl_COLOR_MATERIAL_FACE, gl_SHADE_MODEL, gl_LIGHT_MODEL_AMBIENT,
        gl_LIGHT_MODEL_TWO_SIDE, gl_LIGHT_MODEL_LOCAL_VIEWER, gl_LIGHTING,
        gl_EDGE_FLAG, gl_POLYGON_STIPPLE, gl_POLYGON_MODE, gl_LIST_INDEX,
        gl_LIST_BASE, gl_MAX_LIST_NESTING, gl_LIST_MODE,
        gl_LINE_STIPPLE_REPEAT, gl_LINE_STIPPLE_PATTERN, gl_LINE_STIPPLE,
        gl_POINT_SMOOTH, gl_CURRENT_RASTER_DISTANCE,
        gl_CURRENT_RASTER_POSITION_VALID, gl_CURRENT_RASTER_POSITION,
        gl_CURRENT_RASTER_TEXTURE_COORDS, gl_CURRENT_RASTER_INDEX,
        gl_CURRENT_RASTER_COLOR, gl_CURRENT_TEXTURE_COORDS,
        gl_CURRENT_NORMAL, gl_CURRENT_INDEX, gl_CURRENT_COLOR,
        gl_SELECTION_BUFFER_POINTER, gl_FEEDBACK_BUFFER_POINTER,
        gl_EDGE_FLAG_ARRAY_POINTER, gl_TEXTURE_COORD_ARRAY_POINTER,
        gl_INDEX_ARRAY_POINTER, gl_COLOR_ARRAY_POINTER,
        gl_NORMAL_ARRAY_POINTER, gl_VERTEX_ARRAY_POINTER,
        gl_PIXEL_MAP_A_TO_A, gl_PIXEL_MAP_B_TO_B, gl_PIXEL_MAP_G_TO_G,
        gl_PIXEL_MAP_R_TO_R, gl_PIXEL_MAP_I_TO_A, gl_PIXEL_MAP_I_TO_B,
        gl_PIXEL_MAP_I_TO_G, gl_PIXEL_MAP_I_TO_R, gl_PIXEL_MAP_S_TO_S,
        gl_PIXEL_MAP_I_TO_I, gl_DOMAIN, gl_ORDER, gl_COEFF, gl_EXP2,
        gl_EXP, gl_LINE_RESET_TOKEN, gl_COPY_PIXEL_TOKEN,
        gl_DRAW_PIXEL_TOKEN, gl_BITMAP_TOKEN, gl_POLYGON_TOKEN,
        gl_LINE_TOKEN, gl_POINT_TOKEN, gl_PASS_THROUGH_TOKEN,
        gl_4D_COLOR_TEXTURE, gl_3D_COLOR_TEXTURE, gl_3D_COLOR, gl_3D,
        gl_2D, gl_STACK_UNDERFLOW, gl_STACK_OVERFLOW, gl_AUX3, gl_AUX2,
        gl_AUX1, gl_AUX0, gl_ADD, gl_MULT, gl_RETURN, gl_LOAD, gl_ACCUM,
        gl_POLYGON, gl_QUAD_STRIP, gl_QUADS, gl_CLIENT_ALL_ATTRIB_BITS,
        gl_CLIENT_VERTEX_ARRAY_BIT, gl_CLIENT_PIXEL_STORE_BIT,
        gl_ALL_ATTRIB_BITS, gl_SCISSOR_BIT, gl_TEXTURE_BIT, gl_LIST_BIT,
        gl_EVAL_BIT, gl_HINT_BIT, gl_ENABLE_BIT, gl_TRANSFORM_BIT,
        gl_VIEWPORT_BIT, gl_ACCUM_BUFFER_BIT, gl_FOG_BIT, gl_LIGHTING_BIT,
        gl_PIXEL_MODE_BIT, gl_POLYGON_STIPPLE_BIT, gl_POLYGON_BIT,
