...
module Graphics.Rendering.OpenGL.Raw.Core.Internal.Core40
       (glBlendFuncSeparatei, glBlendFunci, glBlendEquationSeparatei,
        glBlendEquationi, glMinSampleShading, glGetQueryIndexediv,
        glEndQueryIndexed, glBeginQueryIndexed,
        glDrawTransformFeedbackStream, glDrawTransformFeedback,
        ...
        glPatchParameterfv, glPatchParameteri, glGetProgramStageiv,
        glGetUniformSubroutineuiv, glUniformSubroutinesuiv,
        glGetActiveSubroutineName, glGetActiveSubroutineUniformName,
        glGetActiveSubroutineUniformiv, glGetSubroutineIndex,
        glGetSubroutineUniformLocation, glGetUniformdv,
        glUniformMatrix4x3dv, glUniformMatrix4x2dv, glUniformMatrix3x4dv,
        glUniformMatrix3x2dv, glUniformMatrix2x4dv, glUniformMatrix2x3dv,
        glUniformMatrix4dv, glUniformMatrix3dv, glUniformMatrix2dv,
        glUniform4dv, glUniform3dv, glUniform2dv, glUniform1dv,
        glUniform4d, glUniform3d, glUniform2d, glUniform1d,
        glDrawElementsIndirect, glDrawArraysIndirect,
        gl_MAX_TRANSFORM_FEEDBACK_BUFFERS, gl_TRANSFORM_FEEDBACK_BINDING,
        ...
        gl_DOUBLE_MAT4x3, gl_DOUBLE_MAT4x2, gl_DOUBLE_MAT3x4,
        gl_DOUBLE_MAT3x2, gl_DOUBLE_MAT2x4, gl_DOUBLE_MAT2x3,
        gl_DOUBLE_MAT4, gl_DOUBLE_MAT3, gl_DOUBLE_MAT2, gl_DOUBLE_VEC4,
        gl_DOUBLE_VEC3, gl_DOUBLE_VEC2, gl_MAX_VERTEX_STREAMS,
        ...
        gl_INT_SAMPLER_CUBE_MAP_ARRAY, gl_SAMPLER_CUBE_MAP_ARRAY_SHADOW,
        gl_SAMPLER_CUBE_MAP_ARRAY, gl_PROXY_TEXTURE_CUBE_MAP_ARRAY,
