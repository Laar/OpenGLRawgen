...
module Graphics.Rendering.OpenGL.Raw.Core.Internal.Core15
       (glGetBufferPointerv, glGetBufferParameteriv, glUnmapBuffer,
        glMapBuffer, glGetBufferSubData, glBufferSubData, glBufferData,
        glIsBuffer, glGenBuffers, glDeleteBuffers, glBindBuffer,
        glGetQueryObjectuiv, glGetQueryObjectiv, glGetQueryiv, glEndQuery,
        glBeginQuery, glIsQuery, glDeleteQueries, glGenQueries,
        gl_SAMPLES_PASSED, gl_DYNAMIC_COPY, gl_DYNAMIC_READ,
        gl_DYNAMIC_DRAW, gl_STATIC_COPY, gl_STATIC_READ, gl_STATIC_DRAW,
        gl_STREAM_COPY, gl_STREAM_READ, gl_STREAM_DRAW,
        gl_BUFFER_MAP_POINTER, gl_BUFFER_MAPPED, gl_BUFFER_ACCESS,
        gl_READ_WRITE, gl_WRITE_ONLY, gl_READ_ONLY,
        gl_VERTEX_ATTRIB_ARRAY_BUFFER_BINDING,
        gl_ELEMENT_ARRAY_BUFFER_BINDING, gl_ARRAY_BUFFER_BINDING,
        gl_ELEMENT_ARRAY_BUFFER, gl_ARRAY_BUFFER,
        gl_QUERY_RESULT_AVAILABLE, gl_QUERY_RESULT, gl_CURRENT_QUERY,
        gl_QUERY_COUNTER_BITS, gl_BUFFER_USAGE, gl_BUFFER_SIZE)
       where
