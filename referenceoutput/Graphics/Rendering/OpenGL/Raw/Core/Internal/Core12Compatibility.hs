...
module Graphics.Rendering.OpenGL.Raw.Core.Internal.Core12Compatibility
       (glSeparableFilter2D, glResetMinmax, glResetHistogram, glMinmax,
        glHistogram, glGetSeparableFilter, glGetMinmaxParameteriv,
        glGetMinmaxParameterfv, glGetMinmax, glGetHistogramParameteriv,
        glGetHistogramParameterfv, glGetHistogram,
        glGetConvolutionParameteriv, glGetConvolutionParameterfv,
        glGetConvolutionFilter, glGetColorTableParameteriv,
        glGetColorTableParameterfv, glGetColorTable,
        glCopyConvolutionFilter2D, glCopyConvolutionFilter1D,
        glCopyColorTable, glCopyColorSubTable, glConvolutionParameteriv,
        glConvolutionParameteri, glConvolutionParameterfv,
        glConvolutionParameterf, glConvolutionFilter2D,
        glConvolutionFilter1D, glColorTableParameteriv,
        glColorTableParameterfv, glColorTable, glColorSubTable,
        gl_TABLE_TOO_LARGE, gl_SINGLE_COLOR, gl_SEPARATE_SPECULAR_COLOR,
        gl_SEPARABLE_2D, gl_RESCALE_NORMAL, gl_REPLICATE_BORDER, gl_REDUCE,
        ...
        gl_MAX_COLOR_MATRIX_STACK_DEPTH, gl_LIGHT_MODEL_COLOR_CONTROL,
        gl_HISTOGRAM_WIDTH, gl_HISTOGRAM_SINK, gl_HISTOGRAM_RED_SIZE,
