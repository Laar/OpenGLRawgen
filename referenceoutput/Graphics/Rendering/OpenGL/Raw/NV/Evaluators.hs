...
module Graphics.Rendering.OpenGL.Raw.NV.Evaluators
       (glEvalMapsNV, glGetMapAttribParameterfvNV,
        glGetMapAttribParameterivNV, glGetMapParameterfvNV,
        glGetMapParameterivNV, glGetMapControlPointsNV, glMapParameterfvNV,
        glMapParameterivNV, glMapControlPointsNV,
        ...
        gl_EVAL_VERTEX_ATTRIB9_NV, gl_EVAL_VERTEX_ATTRIB8_NV,
        gl_EVAL_VERTEX_ATTRIB7_NV, gl_EVAL_VERTEX_ATTRIB6_NV,
        gl_EVAL_VERTEX_ATTRIB5_NV, gl_EVAL_VERTEX_ATTRIB4_NV,
        gl_EVAL_VERTEX_ATTRIB3_NV, gl_EVAL_VERTEX_ATTRIB2_NV,
        gl_EVAL_VERTEX_ATTRIB1_NV, gl_EVAL_VERTEX_ATTRIB0_NV,
        gl_EVAL_FRACTIONAL_TESSELLATION_NV, gl_MAP_ATTRIB_V_ORDER_NV,
        gl_MAP_ATTRIB_U_ORDER_NV, gl_MAP_TESSELLATION_NV,
        gl_EVAL_TRIANGULAR_2D_NV, gl_EVAL_2D_NV)
       where
