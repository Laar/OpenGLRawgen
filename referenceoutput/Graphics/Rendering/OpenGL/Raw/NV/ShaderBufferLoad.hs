...
module Graphics.Rendering.OpenGL.Raw.NV.ShaderBufferLoad
       (glUniformui64vNV, glUniformui64NV, glProgramUniformui64vNV,
        glProgramUniformui64NV, glMakeNamedBufferResidentNV,
        glMakeNamedBufferNonResidentNV, glMakeBufferResidentNV,
        glMakeBufferNonResidentNV, glIsNamedBufferResidentNV,
        glIsBufferResidentNV, glGetUniformui64vNV,
        glGetNamedBufferParameterui64vNV, glGetIntegerui64vNV,
        glGetBufferParameterui64vNV, gl_MAX_SHADER_BUFFER_ADDRESS_NV,
