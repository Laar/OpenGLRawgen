...
module Graphics.Rendering.OpenGL.Raw.NV.ExplicitMultisample
       (glTexRenderbufferNV, glSampleMaskIndexedNV, glGetMultisamplefvNV,
        ...
        gl_INT_SAMPLER_RENDERBUFFER_NV, gl_SAMPLER_RENDERBUFFER_NV,
        gl_TEXTURE_RENDERBUFFER_NV,
        gl_TEXTURE_RENDERBUFFER_DATA_STORE_BINDING_NV,
        gl_TEXTURE_BINDING_RENDERBUFFER_NV, gl_SAMPLE_MASK_VALUE_NV,
        gl_SAMPLE_MASK_NV, gl_SAMPLE_POSITION_NV)
       where
