...
module Graphics.Rendering.OpenGL.Raw.NV.DepthBufferFloat
       (glDepthRangedNV, glDepthBoundsdNV, glClearDepthdNV,
        gl_FLOAT_32_UNSIGNED_INT_24_8_REV_NV, gl_DEPTH_COMPONENT32F_NV,
        gl_DEPTH_BUFFER_FLOAT_MODE_NV, gl_DEPTH32F_STENCIL8_NV)
       where
