...
module Graphics.Rendering.OpenGL.Raw.NV.PresentVideo
       (glGetVideoui64vNV, glGetVideoi64vNV, glGetVideouivNV,
        glGetVideoivNV, glPresentFrameDualFillNV, glPresentFrameKeyedNV,
        gl_PRESENT_DURATION_NV, gl_PRESENT_TIME_NV, gl_NUM_FILL_STREAMS_NV,
        gl_CURRENT_TIME_NV, gl_FIELDS_NV, gl_FRAME_NV)
       where
