...
module Graphics.Rendering.OpenGL.Raw.AMD.VertexShaderTesselator
       (glTessellationModeAMD, glTessellationFactorAMD, gl_CONTINUOUS_AMD,
        gl_DISCRETE_AMD, gl_TESSELLATION_FACTOR_AMD,
        gl_TESSELLATION_MODE_AMD, gl_UNSIGNED_INT_SAMPLER_BUFFER_AMD,
        gl_INT_SAMPLER_BUFFER_AMD, gl_SAMPLER_BUFFER_AMD)
       where
