...
module Graphics.Rendering.OpenGL.Raw.AMD.PerformanceMonitor
       (glGetPerfMonitorCounterDataAMD, glEndPerfMonitorAMD,
        glBeginPerfMonitorAMD, glSelectPerfMonitorCountersAMD,
        glDeletePerfMonitorsAMD, glGenPerfMonitorsAMD,
        ...
        glGetPerfMonitorGroupsAMD, gl_PERFMON_RESULT_AMD,
        gl_PERFMON_RESULT_SIZE_AMD, gl_PERFMON_RESULT_AVAILABLE_AMD,
        gl_PERCENTAGE_AMD, gl_UNSIGNED_INT64_AMD, gl_COUNTER_RANGE_AMD,
        gl_COUNTER_TYPE_AMD)
       where
