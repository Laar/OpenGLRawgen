...
module Graphics.Rendering.OpenGL.Raw.ARB.Multisample
       (glSampleCoverageARB, gl_MULTISAMPLE_BIT_ARB,
        gl_SAMPLE_COVERAGE_INVERT_ARB, gl_SAMPLE_COVERAGE_VALUE_ARB,
        gl_SAMPLES_ARB, gl_SAMPLE_BUFFERS_ARB, gl_SAMPLE_COVERAGE_ARB,
        gl_SAMPLE_ALPHA_TO_ONE_ARB, gl_SAMPLE_ALPHA_TO_COVERAGE_ARB,
        gl_MULTISAMPLE_ARB)
       where
...
glSampleCoverageARB :: GLclampf -> GLboolean -> IO ()
glSampleCoverageARB
