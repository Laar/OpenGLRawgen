module Graphics.Rendering.OpenGL.Raw.ARB.UniformBufferObject
       (glUniformBlockBinding, glGetActiveUniformBlockName,
        glGetActiveUniformBlockiv, glGetUniformBlockIndex,
        glGetActiveUniformName, glGetActiveUniformsiv, glGetUniformIndices,
        ...
        gl_MAX_GEOMETRY_UNIFORM_BLOCKS, gl_MAX_VERTEX_UNIFORM_BLOCKS,
