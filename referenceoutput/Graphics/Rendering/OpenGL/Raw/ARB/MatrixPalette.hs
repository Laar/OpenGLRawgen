...
module Graphics.Rendering.OpenGL.Raw.ARB.MatrixPalette
       (glMatrixIndexPointerARB, glMatrixIndexuivARB, glMatrixIndexusvARB,
        glMatrixIndexubvARB, glCurrentPaletteMatrixARB,
        gl_MATRIX_INDEX_ARRAY_POINTER_ARB,
        gl_MATRIX_INDEX_ARRAY_STRIDE_ARB, gl_MATRIX_INDEX_ARRAY_TYPE_ARB,
        gl_MATRIX_INDEX_ARRAY_SIZE_ARB, gl_CURRENT_MATRIX_INDEX_ARB,
        gl_MATRIX_INDEX_ARRAY_ARB, gl_CURRENT_PALETTE_MATRIX_ARB,
