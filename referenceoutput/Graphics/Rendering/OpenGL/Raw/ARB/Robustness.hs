...
module Graphics.Rendering.OpenGL.Raw.ARB.Robustness
       (glGetnSeparableFilterARB, glGetnPolygonStippleARB,
        glGetnPixelMapusvARB, glGetnPixelMapuivARB, glGetnPixelMapfvARB,
        glGetnMinmaxARB, glGetnMapivARB, glGetnMapfvARB, glGetnMapdvARB,
        glGetnHistogramARB, glGetnConvolutionFilterARB,
        glGetnColorTableARB, glReadnPixelsARB, glGetnUniformuivARB,
        glGetnUniformivARB, glGetnUniformfvARB, glGetnUniformdvARB,
        glGetnTexImageARB, glGetnCompressedTexImageARB,
        glGetGraphicsResetStatusARB, gl_UNKNOWN_CONTEXT_RESET_ARB,
        gl_RESET_NOTIFICATION_STRATEGY_ARB, gl_NO_RESET_NOTIFICATION_ARB,
        gl_NO_ERROR, gl_LOSE_CONTEXT_ON_RESET_ARB,
