...
module Graphics.Rendering.OpenGL.Raw.ARB.VertexBufferObject
       (glGetBufferPointervARB, glGetBufferParameterivARB,
        glUnmapBufferARB, glMapBufferARB, glGetBufferSubDataARB,
        glBufferSubDataARB, glBufferDataARB, glIsBufferARB,
        glGenBuffersARB, glDeleteBuffersARB, glBindBufferARB,
        gl_DYNAMIC_COPY_ARB, gl_DYNAMIC_READ_ARB, gl_DYNAMIC_DRAW_ARB,
        gl_STATIC_COPY_ARB, gl_STATIC_READ_ARB, gl_STATIC_DRAW_ARB,
        gl_STREAM_COPY_ARB, gl_STREAM_READ_ARB, gl_STREAM_DRAW_ARB,
        gl_BUFFER_MAP_POINTER_ARB, gl_BUFFER_MAPPED_ARB,
        gl_BUFFER_ACCESS_ARB, gl_READ_WRITE_ARB, gl_WRITE_ONLY_ARB,
        gl_READ_ONLY_ARB, gl_VERTEX_ATTRIB_ARRAY_BUFFER_BINDING_ARB,
        ...
        gl_BUFFER_USAGE_ARB, gl_BUFFER_SIZE_ARB)
       where
