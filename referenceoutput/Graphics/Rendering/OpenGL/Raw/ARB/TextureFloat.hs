...
module Graphics.Rendering.OpenGL.Raw.ARB.TextureFloat
       (gl_LUMINANCE_ALPHA16F_ARB, gl_LUMINANCE16F_ARB,
        gl_INTENSITY16F_ARB, gl_ALPHA16F_ARB, gl_RGB16F_ARB,
        gl_RGBA16F_ARB, gl_LUMINANCE_ALPHA32F_ARB, gl_LUMINANCE32F_ARB,
        gl_INTENSITY32F_ARB, gl_ALPHA32F_ARB, gl_RGB32F_ARB,
        gl_RGBA32F_ARB, gl_UNSIGNED_NORMALIZED_ARB,
        gl_TEXTURE_DEPTH_TYPE_ARB, gl_TEXTURE_INTENSITY_TYPE_ARB,
        gl_TEXTURE_LUMINANCE_TYPE_ARB, gl_TEXTURE_ALPHA_TYPE_ARB,
        gl_TEXTURE_BLUE_TYPE_ARB, gl_TEXTURE_GREEN_TYPE_ARB,
