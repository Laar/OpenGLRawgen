...
module Graphics.Rendering.OpenGL.Raw.ARB.TextureCompression
       (glGetCompressedTexImageARB, glCompressedTexSubImage3DARB,
        glCompressedTexSubImage2DARB, glCompressedTexSubImage1DARB,
        glCompressedTexImage3DARB, glCompressedTexImage2DARB,
        glCompressedTexImage1DARB, gl_TEXTURE_COMPRESSION_HINT_ARB,
        gl_TEXTURE_COMPRESSED_IMAGE_SIZE_ARB, gl_TEXTURE_COMPRESSED_ARB,
        gl_NUM_COMPRESSED_TEXTURE_FORMATS_ARB,
        gl_COMPRESSED_TEXTURE_FORMATS_ARB, gl_COMPRESSED_RGB_ARB,
        gl_COMPRESSED_RGBA_ARB, gl_COMPRESSED_LUMINANCE_ARB,
