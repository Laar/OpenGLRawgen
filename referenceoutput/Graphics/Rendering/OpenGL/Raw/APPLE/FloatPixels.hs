...
module Graphics.Rendering.OpenGL.Raw.APPLE.FloatPixels
       (gl_COLOR_FLOAT_APPLE, gl_LUMINANCE_ALPHA_FLOAT16_APPLE,
        gl_LUMINANCE_FLOAT16_APPLE, gl_INTENSITY_FLOAT16_APPLE,
        gl_ALPHA_FLOAT16_APPLE, gl_RGB_FLOAT16_APPLE,
        gl_RGBA_FLOAT16_APPLE, gl_LUMINANCE_ALPHA_FLOAT32_APPLE,
        gl_LUMINANCE_FLOAT32_APPLE, gl_INTENSITY_FLOAT32_APPLE,
        gl_ALPHA_FLOAT32_APPLE, gl_RGB_FLOAT32_APPLE,
        gl_RGBA_FLOAT32_APPLE, gl_HALF_APPLE)
       where
