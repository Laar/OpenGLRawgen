...
module Graphics.Rendering.OpenGL.Raw.APPLE.TextureRange
       (glGetTexParameterPointervAPPLE, glTextureRangeAPPLE,
        gl_STORAGE_SHARED_APPLE, gl_STORAGE_CACHED_APPLE,
        gl_STORAGE_PRIVATE_APPLE, gl_TEXTURE_STORAGE_HINT_APPLE,
        gl_TEXTURE_RANGE_POINTER_APPLE, gl_TEXTURE_RANGE_LENGTH_APPLE)
       where
