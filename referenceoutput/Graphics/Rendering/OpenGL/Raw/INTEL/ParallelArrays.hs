...
module Graphics.Rendering.OpenGL.Raw.INTEL.ParallelArrays
       (glTexCoordPointervINTEL, glColorPointervINTEL,
        glNormalPointervINTEL, glVertexPointervINTEL,
        gl_TEXTURE_COORD_ARRAY_PARALLEL_POINTERS_INTEL,
        gl_COLOR_ARRAY_PARALLEL_POINTERS_INTEL,
        gl_NORMAL_ARRAY_PARALLEL_POINTERS_INTEL,
        gl_VERTEX_ARRAY_PARALLEL_POINTERS_INTEL, gl_PARALLEL_ARRAYS_INTEL)
       where
